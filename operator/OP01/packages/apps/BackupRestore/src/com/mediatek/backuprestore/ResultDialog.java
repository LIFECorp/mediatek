...
public class ResultDialog {
    ...
    public static AlertDialog createResultDlg(final Context context, final int titleId, final Bundle args,
            final DialogInterface.OnClickListener listener) {
        AlertDialog dialog = new AlertDialog.Builder(context).setCancelable(false).setTitle(titleId)
                .setPositiveButton(R.string.btn_ok, listener).setAdapter(createEmptyAdapter(context), null).create();
