...
//        if(1 == Camera_check_crc(pImgBufInfo->RAWImgBufInfo.bufAddr,gCRCValue,pImgBufInfo->RAWImgBufInfo.imgSize))
	    if(1 == Camera_check_crc(pImgBufInfo->RAWImgBufInfo.bufAddr,gCRCValue,(gImgW*gImgH*10)/8))
        {
...
//		if(1 == Camera_check_crc(pImgBufInfo->imgBufInfo.bufAddr,gCRCValue,(gImgW*gImgH*16)/8))
        {
            gPinError_pass = MTRUE;
            FTM_CAMERA_DBG("CRC Pass\n");
