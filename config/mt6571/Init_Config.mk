...
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/fs.mlc.rc:root/fs.rc
else
PRODUCT_COPY_FILES += $(MTK_ROOT_CONFIG_OUT)/fs.rc:root/fs.rc
endif
...
PRODUCT_COPY_FILES += $(strip \
                        $(foreach file,$(call wildcard, $(MTK_ROOT_CONFIG_OUT)/*.xml), \
