...
#define LIB_PATH_PROPERTY   "rild.dongle.libpath"
#define LIB_ARGS_PROPERTY   "rild.dongle.libargs"
...
OpenLib:
...
#else
    {
        ...
        if ((0 == property_get("rild.mark_switchuser", mark_switchuser, NULL)) || (mark_switchuser[0] == '0') ) {
            switchUser();
            ALOGD("switch user to radio from root.");
        }
    }
#endif
#endif
    ...
    if (hasLibArgs) {
        ...
        rilArgv = newArgv;
        //set the value of LIB_ARGS_PROPERTY
