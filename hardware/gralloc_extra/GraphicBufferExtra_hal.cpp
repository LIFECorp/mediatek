...
extern "C" int gralloc_extra_computeSize(int width, int height, int format)
{
	return GraphicBufferExtra::computeSize(width, height, format);
}

extern "C" int gralloc_extra_computeSize_stride(int width, int height, int stride, int format)
{
	return GraphicBufferExtra::computeSize_stride(width, height, stride, format); 
}
