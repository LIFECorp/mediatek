 ...
 if(Fix_framerate==0)
 	{
 	 if(HI542MIPI_720P == HI542MIPI_g_RES)
 	 	{
		 HI542MIPI_write_cmos_sensor(0x0120, ((iExp+4*PixelsOneline) >> 24) & 0xFF);
		 HI542MIPI_write_cmos_sensor(0x0121, ((iExp+4*PixelsOneline) >> 16) & 0xFF);
		 HI542MIPI_write_cmos_sensor(0x0122, ((iExp+4*PixelsOneline) >> 8 ) & 0xFF);
		 HI542MIPI_write_cmos_sensor(0x0123, ((iExp+4*PixelsOneline)) & 0xFF);
...
//changed by zhiqiang original 35
	...
	HI542MIPI_write_cmos_sensor(0x0070,0x00);	//EMI OFF 0x03
...
*/
	...
	HI542MIPI_write_cmos_sensor(0x021A,0x35);  //15
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    HI542MIPI_Set_Mirror_Flip(sensor_config_data->SensorImageMirror);
