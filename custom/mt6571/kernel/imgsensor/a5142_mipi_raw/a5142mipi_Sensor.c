...
#define A5142mipi_TEST_PATTERN_CHECKSUM (0xc9e24698)  //0xc9e24698
...
UINT32 A5142mipiSetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, UINT32 frameRate)
{
    ...
    switch(scenarioId) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            pclk = A5142mipi_sensor.preview_vt_clk*100000;  
            ...
            A5142mipi_SetDummy(KAL_TRUE, 0, dummyLine);
            break;
...
UINT32 A5142mipiGetSensorID(UINT32 *sensorID) 
{
    ...
    for(i = 0; i < sizeof(i2c_addr) / sizeof(i2c_addr[0]); i++)
    {
        ...
        SENSORDB("sensor_id == %x !!!!!!!!!!!!!!!!!!!1", sensor_id);
