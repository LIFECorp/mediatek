...
const NVRAM_LENS_PARA_STRUCT BU64241_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 BU64241_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &BU64241_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pBU64241_getDefaultData = BU64241_getDefaultData;
