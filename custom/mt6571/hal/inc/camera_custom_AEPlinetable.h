...
typedef enum                           
{
    ...
    LIB3A_AE_MODE_PREVIEW                      = 101,
    LIB3A_AE_MODE_VIDEO                          = 102,
    LIB3A_AE_MODE_VIDEO_DYNAMIC         = 103,
    LIB3A_AE_MODE_VIDEO_NIGHT              = 104,
    LIB3A_AE_MODE_VIDEO_NIGHT_DYNAMIC  = 105,
    LIB3A_AE_MODE_CAPTURE                          = 106,
    LIB3A_AE_MODE_CAPTURE_ISO100           = 107,
    LIB3A_AE_MODE_CAPTURE_ISO200           = 108,
    LIB3A_AE_MODE_CAPTURE_ISO400           = 109,
    LIB3A_AE_MODE_CAPTURE_ISO800           = 110,
    LIB3A_AE_MODE_CAPTURE_ISO1600         = 111,
    LIB3A_AE_MODE_MAX 
} LIB3A_AE_MODE_T;
