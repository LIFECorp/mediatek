#ifndef __ARCH_ARM_MACH_MT65XX_CUSTOM_BOARD_H
#define __ARCH_ARM_MACH_MT65XX_CUSTOM_BOARD_H
...
#if defined(FPGA_EARLY_PORTING)		// FPGA Only support 1 NAND device
#define NFI_CS_NUM                  (1)
#else
#define NFI_CS_NUM                  (2)
#endif
...
#endif /* __ARCH_ARM_MACH_MT65XX_CUSTOM_BOARD_H */
