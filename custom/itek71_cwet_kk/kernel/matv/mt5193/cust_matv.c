...
{  
    ...
    if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_IO, VOL_1800,"MT5192"))
    {
    ...
    if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_A, VOL_2800,"MT5192"))
    {
    ...
    if(TRUE != hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_D, VOL_1500,"MT5192"))
    {
    MATV_LOGE("[CAMERA SENSOR] Fail to enable digital power\n");
    //return -EIO;
    return 0;
...
{  
    ...
    if(TRUE != hwPowerDown(PMIC_APP_MAIN_CAMERA_POWER_A,"MT5192")) {
        MATV_LOGE("[CAMERA SENSOR] Fail to OFF analog power\n");
        //return -EIO;
        return 0;
    }
    if(TRUE != hwPowerDown(PMIC_APP_MAIN_CAMERA_POWER_D, "MT5192")) {
        MATV_LOGE("[CAMERA SENSOR] Fail to OFF digital power\n");
        //return -EIO;
        return 0;
    }
    if(TRUE != hwPowerDown(PMIC_APP_MAIN_CAMERA_POWER_IO,"MT5192"))
    {
        MATV_LOGE("[CAMERA SENSOR] Fail to enable digital power\n");
        //return -EIO;
        return 0;
