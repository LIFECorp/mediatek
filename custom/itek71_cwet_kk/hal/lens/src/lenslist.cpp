...
#if defined(AD5823)
extern PFUNC_GETLENSDEFAULT pAD5823_getDefaultData;
#endif

#if defined(BU64241)
extern PFUNC_GETLENSDEFAULT pBU64241_getDefaultData;
#endif

MSDK_LENS_INIT_FUNCTION_STRUCT LensList[MAX_NUM_OF_SUPPORT_LENS] =
{
	{OV9726MIPI_SENSOR_ID, DUMMY_LENS_ID, "Dummy", pDummy_getDefaultData},
...
#if defined(AD5823)
        {OV5648MIPI_SENSOR_ID, AD5823AF_LENS_ID, "AD5823", pAD5823_getDefaultData},
#endif

#if defined(BU64241)
        {S5K4H5YX_2LANE_SENSOR_ID, BU64241_LENS_ID, "BU64241", pBU64241_getDefaultData},
#endif
