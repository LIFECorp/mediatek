...
static jint getSupportedFeatures(JNIEnv* env, jobject clazz) {
    jint result = 0;
#if defined (MTK_HDMI_SUPPORT)
...
#endif
    ALOGI("[HDMI] JNI com.mediatek.hdmi.HDMINative.getSupportedFeatures(%d)\n", result);
    return result;
}
...
//    { "GetDeviceStatus","(ZZ)Z", 	(void*)GetDeviceStatus},
    ...
    { "getSupportedFeaturesNative",     "()I",       (void*)getSupportedFeatures},
};
