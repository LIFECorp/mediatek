...
#define DxSize_t  DxSize

#define DxUintPtr_t       DxUintPtr
#define DxIntPtr_t       DxIntPtr
...
#else
#define DX_UNREFERENCED(varName) (void)varName
#endif
...
#define DX_OFFSET_OF(s,m)   offsetof(s,m)
