...
DxUint64 DxDrmVersion_ConvertVersionToIntegerFormat(DxChar* buff);
DxUint64 DxDrmVersion_ConvertVersionBuildToIntegerFormat(DxChar* buff);

DxUint64 DxDrmVersion_GetVersionInIntegerFormat();
DxUint64 DxDrmVersion_GetVersionBuildInIntegerFormat();
