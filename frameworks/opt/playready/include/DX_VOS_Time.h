...
/*! returns number of milliseconds since the device was booted, including time spent in sleep.
	 
	\note This value is 64-bits and should not wrap around. 
	Suitable for duration measurements only.
	*/
DxUint64 DX_VOS_GetBootTickCount(void);
