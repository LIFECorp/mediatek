...
void* _DX_VOS_DebugMemMallocNoFail(const DxChar* fileName, DxInt32 lineNum, 
                                            const DxChar* funcName, DxUint size);

void* _DX_VOS_DebugMemMalloc(const DxChar* fileName, DxInt32 lineNum, 
									  const DxChar* funcName, DxUint size);
void _DX_VOS_DebugMemFree(const DxChar* fileName, DxInt32 lineNum, 
									const DxChar* funcName, void* aBuff);
void* _DX_VOS_DebugMemRealloc(	const DxChar* fileName, DxInt32 lineNum, 
