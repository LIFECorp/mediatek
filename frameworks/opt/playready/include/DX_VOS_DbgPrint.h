...
typedef void (*DxPrintfFunc_t)(
	...
	DxInt32 lineNum,		/*!< Number of line from which the printing macro was called.
...
void DX_VOS_DebugPrint(DxUint32 ModuleCode, const DxChar *fileName, DxInt32 lineNum, 
...
void DX_VOS_DebugStdoutPrint(DxUint32 moduleCode, DxUint32 debugLevel,
                             const DxChar *fileName, DxInt32 lineNum, const DxChar *funcName, 
...
Only available when compiling for Android */
#ifdef WIN32
void DX_VOS_DebugWin32Print(DxUint32 moduleCode, DxUint32 debugLevel,
                            const DxChar *fileName, DxInt32 lineNum, const DxChar *funcName, 
                            const DxChar* aDate, const DxChar* aTime, const DxChar *format, DX_VA_LIST arg_list);
#endif
