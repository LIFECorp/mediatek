...
public class RadioInfo extends Activity {
    ...
    private static final int NOT_SPECIFIED_INDEX = FeatureOption.MTK_LTE_SUPPORT ? 8 : 4;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mIsTddType) {            
            ...
            if (!FeatureOption.MTK_LTE_SUPPORT) {
                labels[NOT_SPECIFIED_INDEX] = "Not Specified";
                labels = Arrays.copyOf(labels, NOT_SPECIFIED_INDEX + 1);
            }
