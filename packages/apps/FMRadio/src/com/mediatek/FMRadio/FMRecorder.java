    ...
    public void startRecording(Context context) {
        ...
        */
        ...
        try {
            ...
            LogUtils.e(TAG, "IllegalStateException while starting recording!", e);
            setError(ERROR_RECORDER_INTERNAL);
            return;
        } catch (IOException e) {
            LogUtils.e(TAG, "IOException while starting recording!", e);
            setError(ERROR_RECORDER_INTERNAL);
            return;
        } catch (RuntimeException exception) {
            LogUtils.e(TAG, "RuntimeException while start recording", exception);
            setError(ERROR_RECORDER_INTERNAL);
            return;
        }
