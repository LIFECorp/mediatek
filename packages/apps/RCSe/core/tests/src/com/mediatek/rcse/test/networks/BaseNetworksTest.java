...
abstract public class BaseNetworksTest extends AndroidTestCase implements
    ...
    private void prepareParameters() {
        ...
        settings.setImsProxyAddrForMobile(mCurrentAccount.mSipProxyAddress,1);
        settings.setImsProxyAddrForWifi(mCurrentAccount.mSipProxyAddress,1);
        settings.setImsProxyPortForMobile(Integer.parseInt(mCurrentAccount.mSipProxyPort),1);
        settings.setImsProxyPortForWifi(Integer.parseInt(mCurrentAccount.mSipProxyPort),1);
