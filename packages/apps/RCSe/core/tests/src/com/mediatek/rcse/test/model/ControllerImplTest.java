...
public class ControllerImplTest extends InstrumentationTestCase {
    ...
    private class MockMessagingApi extends MessagingApi {
        ...
        @Override
        public IChatSession initiateAdhocGroupChatSession(List<String> participants,String x)
                throws ClientApiException {
            return super.initiateAdhocGroupChatSession(participants, null);
        }
    ...
    private class MockFtSession implements IFileTransferSession {
		...
		public String getRemoteFtContact() {
			return null;
		}
