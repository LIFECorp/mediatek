...
public class RcsNotification {
    ...
    private void handlePluginGroupChatInvitation(Context context, Intent invitation, boolean autoAccept) {
        ...
        InstantMessage firstMessage = invitation.getParcelableExtra(FIRST_MESSAGE);
		if(firstMessage != null){
			Logger.v(TAG, "handlePluginGroupChatInvitation() firstmessage:"+ firstMessage.getTextMessage());
		}
		else{
			Logger.v(TAG, "handlePluginGroupChatInvitation() firstmessage:NULL");
		}
