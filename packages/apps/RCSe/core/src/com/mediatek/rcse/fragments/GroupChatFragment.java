...
@Override
                ...
                public void run() {
                    ...
                    if (null != manager) {
                        switch (mFiletransferEnableStatus) {
                            case GroupChat.FILETRANSFER_DISABLE_REASON_CAPABILITY_FAILED:
                            case GroupChat.FILETRANSFER_DISABLE_REASON_NOT_REGISTER:
                            case GroupChat.FILETRANSFER_DISABLE_REASON_REMOTE:
                            case GroupChat.GROUPFILETRANSFER_DISABLE:
                                ...
                                break;
                            case GroupChat.FILETRANSFER_ENABLE_OK:
    ...
    public static class ReceivedMessage implements IReceivedChatMessage, IChatMessage  {
        ...
        public String getAliasName(){
        	if (mMessage == null) {
                Logger.w(TAG, "mMessage is null, as a result no alias returned");
                return null;
            }
        	return mMessage.getAlias();
        }
    }
