    ...
    private void parsePcscfAddress(Node node) {
        ...
        if (childnode != null) {
            ...
            for(int i=0;i<nbAddress;i++){
            	...
            	int sufix=i+1;
            	String key_mobile="ImsOutboundProxyAddrForMobile"+sufix;
            	String key_wifi="ImsOutboundProxyAddrForWifi"+sufix;
            	String key_mobile_port="ImsOutboundProxyPortFormobile"+sufix;
            	String key_wifi_port="IImsOutboundProxyPortForWifi"+sufix;
