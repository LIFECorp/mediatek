...
public class ProfileProvisioning extends Activity {
	...
	protected void onResume() {
		...
		txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.IMS_PROXY_ADDR_MOBILE_1));

        txt = (EditText)this.findViewById(R.id.ImsOutboundProxyPortForMobile);
		txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.IMS_PROXY_PORT_MOBILE_1));

		txt = (EditText)this.findViewById(R.id.ImsOutboundProxyAddrForWifi);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_1));

		txt = (EditText)this.findViewById(R.id.ImsOutboundProxyPortForWifi);
        txt.setText(RcsSettings.getInstance().readParameter(RcsSettingsData.IMS_PROXY_PORT_WIFI_1));
    ...
    private void save() {
        ...
        txt = (EditText)this.findViewById(R.id.ImsOutboundProxyAddrForMobile);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.IMS_PROXY_ADDR_MOBILE_1, txt.getText().toString());

        txt = (EditText)this.findViewById(R.id.ImsOutboundProxyPortForMobile);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.IMS_PROXY_PORT_MOBILE_1, txt.getText().toString());

        txt = (EditText)this.findViewById(R.id.ImsOutboundProxyAddrForWifi);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_1, txt.getText().toString());

        txt = (EditText)this.findViewById(R.id.ImsOutboundProxyPortForWifi);
        RcsSettings.getInstance().writeParameter(RcsSettingsData.IMS_PROXY_PORT_WIFI_1, txt.getText().toString());
