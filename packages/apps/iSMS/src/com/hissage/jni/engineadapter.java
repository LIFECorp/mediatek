...
public final class engineadapter {
    ...
    public native int nmsUIDeleteMsg(short[] recordId, int number, int isDelSavedMsg,
            int isDelMsgInSmsDb);
    ...
    public native int nmsUIDeleteMsgViaContactRecId(short contactRecId, int isDelSavedMsg,
            int isDelHolderMsg, int isDelMsgInSmsDb);
    ...
    public native short[] nmsUIGetServiceContactList(); // add for ODM virtual
                                                        // number
