...
public class NmsStartActivityApi {
    ...
    public static void nmsStartChatDetailsActivity(Context context, long threadId, int contactId,
            long selectId, boolean needShowLoadAllMsg, boolean needStartNewTask) {
        if (null == context) {
    ...
    public static void nmsStartContactSelectionActivityForResult(final Context context,
        ...
        if (simId == -1) {
            ...
            if (!NmsAlertDialogUtils
                    .checkSimCardActivty(context, nmsContext, simId, requestCode, 0)) {
