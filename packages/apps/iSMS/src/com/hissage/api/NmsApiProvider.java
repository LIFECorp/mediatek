...
public class NmsApiProvider extends ContentProvider {
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        ...
        case FUNC_ID_nmsSaveIpMsg:
            retBundle.putInt(
                    ...
                    NmsIpMessageApiNative.nmsSaveIpMsg(
                            (NmsIpMessage) extras.getSerializable(method + 1),
                            extras.getInt(method + 2, 0), false, false));
            break;
        ...
        case FUNC_ID_nmsAddContactToSpamList:
            retBundle
                    .putBoolean(method, NmsIpMessageApiNative.nmsAddContactToSpamList(extras
                            .getShortArray(method + 1)));
            break;
        case FUNC_ID_nmsDeleteContactFromSpamList:
            retBundle.putBoolean(method, NmsIpMessageApiNative.nmsDeleteContactFromSpamList(extras
                    .getShortArray(method + 1)));
            break;
        ...
        case FUNC_ID_nmsDeleteDraftMsgInThread:
            retBundle
                    .putInt(method, NmsIpMessageApiNative.nmsDeleteDraftMsgInThread(extras.getLong(
                            method + 1, -1)));
            break;
        // M: Activation Statistics
        case FUNC_ID_nmsAddActivatePromptStatistics:
            NmsIpMessageApiNative.nmsAddActivatePromptStatistics(extras.getInt(method + 1,
                    NmsIpMessageConsts.NmsUIActivateType.OTHER));
            break;

        case FUNC_ID_nmsIsIpMessageSrvNumber:
            retBundle
                    .putBoolean(method, NmsIpMessageApiNative.nmsIsIpMessageSrvNumber(extras
                            .getString(method + 1, "")));
            break;
        case FUNC_ID_nmsGetIpMessageSrvNumberName:
            retBundle.putString(method, NmsIpMessageApiNative.nmsGetIpMessageSrvNumberName(extras
                    .getString(method + 1, "")));
            break;
