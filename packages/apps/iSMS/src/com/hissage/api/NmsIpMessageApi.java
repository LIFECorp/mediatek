...
public class NmsIpMessageApi {
    ...
    public int nmsDeleteDraftMsgInThread(long threadId) {
        try {
            ...
            Bundle back = mApiProviders.call(API_CONTENT_URI, FUNC_ID_nmsDeleteDraftMsgInThread,
                    null, param);
            if (back != null)
    ...
    public void nmsAddActivatePromptStatistics(int type) {
        try {
            ...
            mApiProviders
                    .call(API_CONTENT_URI, FUNC_ID_nmsAddActivatePromptStatistics, null, param);
        } catch (Exception e) {
            NmsLog.nmsPrintStackTrace(e);
        }
    }
    ...
    public boolean nmsIsIpMessageSrvNumber(String number) {
        ...
        try {
            Bundle back = mApiProviders.call(API_CONTENT_URI, FUNC_ID_nmsIsIpMessageSrvNumber,
                    null, param);
            if (back != null) {
    ...
    public boolean nmsIsIpMsgSendable(String number) {
        ...
        try {
            Bundle back = mApiProviders.call(API_CONTENT_URI, FUNC_ID_nmsIsIpMsgSendable, null,
                    param);
            if (back != null) {
    ...
    public String nmsGetUnifyPhoneNumber(String number) {
        ...
        try {
            Bundle back = mApiProviders.call(API_CONTENT_URI, FUNC_ID_getUnifyPhoneNumber, null,
                    param);
            if (back != null) {
