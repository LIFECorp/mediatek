...
public class SNmsMsgType {
    ...
    public final static int NMS_UI_MSG_REG_SMS_NOC_TIME = 57;
    public final static int NMS_UI_MSG_REG_SMS_SELF_TIME = 58;
    public final static int NMS_UI_MSG_MAX = 59;
