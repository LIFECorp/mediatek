...
public class SNmsErrorCode {
    ...
    public static final int NMS_ERROR_INVALID_MSG_DB_ID = -6; // 严重错误：非法的msg db
                                                              // id
    public static final int NMS_ERROR_ADD_MSG_DB_FAILED = -7; // 严重错误：插入一条记录到msg
                                                              // db 错误
    public static final int NMS_ERROR_UPDATE_MSG_DB_FAILED = -8; // 严重错误：更新一条msg
                                                                 // db 记录错误
    public static final int NMS_ERROR_GET_MSG_DB_DATA_FAILED = -9; // 严重错误：获取msg
                                                                   // db 数据错误

    public static final int NMS_ERROR_INVALID_CONTACT_DB_ID = -10; // 严重错误：非法的contact
                                                                   // db id
    public static final int NMS_ERROR_ADD_CONTACT_DB_FAILED = -11; // 严重错误：插入一条记录到contact
                                                                   // db 错误
    public static final int NMS_ERROR_UPDATE_CONTACT_DB_FAILED = -12; // 严重错误：更新一条contact
                                                                      // db 记录错误
    public static final int NMS_ERROR_GET_CONTACT_DB_DATA_FAILED = -13; // 严重错误：获取contact
                                                                        // db
                                                                        // 数据错误
    ...
    public static final int NMS_ERROR_NEW_IP_MSG_GCHAT_INVALID_SIM_ID = -19; // 发送IP群聊消息：群聊不属于传入的sim
                                                                             // card
    ...
    public static final int NMS_ERROR_GCHAT_INVALID_MEMBER_WITH_SELF = -24; // 群聊控制相关：创建/添加时成员包含自己的号码(多卡下为群聊所属sim
                                                                            // card的号码)
    ...
    public static final int NMS_ERROR_GCHAT_SIM_IS_NOT_ACTIVATED = -27; // 群聊控制相关：群聊所属sim
                                                                        // card
                                                                        // 处于未激活状态
    ...
    public static final int NMS_ERROR_SIM_INFO_NOT_FOUND = -35; // Enable/Disable
                                                                // Sim card
                                                                // 失败：engine没有找到相关的sim
                                                                // card信息
    public static final int NMS_ERROR_SIM_IN_INVALID_STATUS = -36; // Enable/Disable
                                                                   // Sim card
                                                                   // 失败：sim
                                                                   // card处于一个错误状态

    public static final int NMS_ERROR_CMD_PROCESSING = -37; // 系统忙，不能处理config
                                                            // center命令(设置和信信息时需检查该返回值)
