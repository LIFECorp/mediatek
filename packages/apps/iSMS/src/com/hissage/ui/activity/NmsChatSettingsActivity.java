...
public class NmsChatSettingsActivity extends PreferenceActivity implements
    ...
    private void downloadChatHistroy() {
        ...
        if (availableSpace <= 5 * 1024 * 1024) {
            // new
            // AlertDialog.Builder(NmsChatSettingsActivity.this).setTitle(R.string.STR_NMS_TIPTITLE)
            // .setMessage(R.string.STR_NMS_SDSPACE_NOT_ENOUGH)
            // .setPositiveButton(R.string.STR_NMS_OK, null).create().show();
            Toast.makeText(NmsChatSettingsActivity.this, R.string.STR_NMS_SDSPACE_NOT_ENOUGH,
                    Toast.LENGTH_LONG).show();
            mNeedEmail = false;
            return;
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mWallpaper) {
            ...
            new AlertDialog.Builder(NmsChatSettingsActivity.this)
                    .setTitle(R.string.STR_NMS_SVAE_TITLE)
            ...
            new AlertDialog.Builder(NmsChatSettingsActivity.this)
                    .setTitle(R.string.STR_NMS_EMAIL_TITLE)
                    .setIcon(R.drawable.ic_dialog_alert_holo_light)
