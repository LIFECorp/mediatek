...
public class NmsAboutActivity extends ListActivity {
    ...
    protected void showActivitionDlg() {
        ...
        mVersionDlg = new AlertDialog.Builder(this)
                .setTitle(R.string.STR_NMS_MENU_VERSION_INFORMATION).setView(view)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] aboutOptionList = new String[] {
                getResources().getString(R.string.STR_NMS_MENU_FUNCTION_INTRODUCTION),
    ...
    protected void onListItemClick(ListView arg0, View arg1, int arg2, long arg3) {
        ...
        switch (arg2) {
        case 0:
            Intent functionIntroductionIntent = new Intent(NmsAboutActivity.this,
                    NmsFunctionIntroductionActivity.class);
            startActivity(functionIntroductionIntent);
            break;
        case 1:
            Intent licenseAgreementIntent = new Intent(NmsAboutActivity.this,
                    NmsLicenseAgreementActivity.class);
            startActivity(licenseAgreementIntent);
            break;
        case 2:
            /*
             * Intent versionInformationIntent = new
             * Intent(NmsAboutActivity.this, NmsNewEditGroupChatActivity.class);
