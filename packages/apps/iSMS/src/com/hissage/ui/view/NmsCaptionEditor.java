...
public class NmsCaptionEditor extends LinearLayout implements TextWatcher {
    ...
    public NmsCaptionEditor(Context context, AttributeSet attrs) {
        ...
        mAttachThumbnailDelete = (ImageView) mConvertView
                .findViewById(R.id.iv_attach_thumbnail_delete);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        // TODO Auto-generated method stub
        // NmsLog.error("captionEditor",
        // String.format("on text changed is called start:%d, before:%d, count:%d",
        // start, before, count)) ;
    }
            ...
            mHandler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        NmsLog.error("captionEditor",
                                "got execption in setEmoticon: " + e.toString());
                        mIsHandling = false;
                    }
                }
