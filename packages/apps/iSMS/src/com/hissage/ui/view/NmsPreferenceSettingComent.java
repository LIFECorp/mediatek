...
public class NmsPreferenceSettingComent extends Preference {
    ...
    public NmsPreferenceSettingComent(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onBindView(View view) {
        ...
        ss.setSpan(new URLSpan("noting"),
                sContent.indexOf(context.getResources().getString(R.string.STR_NMS_KNOW_MORE)),
                sContent.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private class MyURLSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            Intent functionIntroductionIntent = new Intent(context,
