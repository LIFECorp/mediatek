...
public class NmsIpMessageConsts {
    public static final int SWITCHVARIABLE = 0;// UINT32 read burn(8192) +
                                               // activation(4096) + private
                                               // message(2048) + close menu
                                               // setting shortcut(1024): 14336
    ...
    public static final class NmsIpMessageMediaTypeFlag {
        ...
        public static final int ALL = PICTURE | VOICE | VCARD | LOCATION | SKETCH | VIDEO
                | CALENDAR;
    }
    ...
    public static final class NmsUIActivateType {
        ...
        public static final int WAKEUP = 9;
