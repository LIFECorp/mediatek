...
public class NmsHesineApiConsts {
    ...
    public static final class NmsImReadMode {
        ...
        public static final int NMS_IM_READ_MODE_SELECT = (NMS_IM_READ_MODE_TEXT
                | NMS_IM_READ_MODE_PIC | NMS_IM_READ_MODE_TAPE | NMS_IM_READ_MODE_VCARD
                | NMS_IM_READ_MODE_LOCATION | NMS_IM_READ_MODE_SKETCH | NMS_IM_READ_MODE_CALENDAR
                | NMS_IM_READ_MODE_VIDEO | NMS_IM_READ_MODE_UNKNOWN | NMS_IM_READ_MODE_EXT_MMS);
    }
