...
public class NmsIpImageMessage extends NmsIpAttachMessage {
    ...
    public NmsIpImageMessage(int jid, int jipDbId, int jsimId, int jtype, int jstatus,
            int jprotocol, boolean jread, int jflag, int jtime, int jtimesend, String jto,
            String jfrom, String jpath, String jurl, int jsize, String jcaption, String jthumbPath) {
        super(jid, jipDbId, jsimId, jtype, jstatus, jprotocol, jread, jflag, jtime, jtimesend, jto,
                jfrom, jpath, jurl, jsize);
        caption = jcaption;
    ...
    public void send(final Context context, int flag, String number, final String attachPath,
            String caption, int simId, final int sendMode, final short contactId,
            final boolean delDraft, final Handler handler) {
        ...
        mExecutorService.submit(new Runnable() {
            ...
            public void run() {
                ...
                if (NmsIpMessageApiNative.nmsSaveIpMsg(mInstance, sendMode, delDraft, true) < 0
                        && handler != null)
                    handler.sendEmptyMessage(MessageConsts.NMS_SEND_MSG_FAILED);
            }
        });
