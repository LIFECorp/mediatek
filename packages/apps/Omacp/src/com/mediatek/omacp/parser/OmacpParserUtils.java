...
public class OmacpParserUtils {
    ...
    public static void handlePxParameters(String listType, String type, String parmName,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handlePxParameters listType = " + listType + " type = " + type +
                " parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handlePxLogicalParams(String parmName, String parmValue, ProxyClass px) {
        MTKlog.d(TAG, "OmacpParserUtils handlePxLogicalParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleLowUsePxLogicalParams(String parmName, String parmValue, ProxyClass px) {
        MTKlog.d(TAG, "OmacpParserUtils handleLowUsePxLogicalParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handlePxAuthInfoParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handlePxAuthInfoParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handlePortParams(String parmName, String parmValue, String listType,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handlePortParams parmName = " + parmName + " parmValue = " + parmValue
                + " listType = " + listType);
    ...
    private static void handlePxPhysicalParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handlePxPhysicalParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    public static void handleNapParameters(String type, String parmName, String parmValue,
            NapdefClass nap) {
        MTKlog.d(TAG, "OmacpParserUtils handleNapParameters parmName = " + parmName + " parmValue = " + parmValue);
        // TODO Auto-generated method stub
        if (nap == null) {
    ...
    private static void handleNapDefParams(String parmName, String parmValue, NapdefClass nap) {
        MTKlog.d(TAG, "OmacpParserUtils handleNapDefParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleNapDefAddrParams(String parmName, String parmValue, NapdefClass nap) {
        MTKlog.d(TAG, "OmacpParserUtils handleNapDefAddrParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleNapDefLinkParams(String parmName, String parmValue, NapdefClass nap) {
        MTKlog.d(TAG, "OmacpParserUtils handleNapDefLinkParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleNapDefMaxParams(String parmName, String parmValue, NapdefClass nap) {
        MTKlog.d(TAG, "OmacpParserUtils handleNapDefMaxParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleLowUseNapDefParams(String parmName, String parmValue, NapdefClass nap) {
        MTKlog.d(TAG, "OmacpParserUtils handleLowUseNapDefParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleNapAuthInfoParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleNapAuthInfoParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleValidityParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleValidityParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    public static void handleApParameters(String type, String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleApParameters parmName = " + parmName + " parmValue = " + parmValue);
        if (application == null) {
    ...
    private static void handleApplicationParams(String type, String parmName, String parmValue,
            ApplicationClass application) {
        MTKlog.d(TAG, "OmacpParserUtils handleApplicationParams parmName = " + parmName + " parmValue = "
                + parmValue + " type = " + type);
    ...
    private static void handleOtherApplicationParams(String type, String parmName,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleOtherApplicationParams parmName = " + parmName + " parmValue = "
                + parmValue + " type = " + type);
    ...
    private static void handleOtherAddrApplicationParams(String type, String parmName,
            String parmValue, ApplicationClass application) {
        MTKlog.d(TAG, "OmacpParserUtils handleOtherAddrApplicationParams parmName = " + parmName + " parmValue = "
                + parmValue + " type = " + type);
    ...
    private static void handleLowUseApplicationParams(String type, String parmName,
            String parmValue, ApplicationClass application) {
        MTKlog.d(TAG, "OmacpParserUtils handleLowUseApplicationParams parmName = " + parmName + " parmValue = "
                + parmValue + " type = " + type);
    ...
    private static void handleAppAddrParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleLowUseApplicationParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleAppAuthParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleAppAuthParams parmName = " + parmName + " parmValue = " + parmValue);
    ...
    private static void handleOtherResourceParams(String parmName, String parmValue,
        ...
        MTKlog.d(TAG, "OmacpParserUtils handleAppAuthParams parmName = " + parmName + " parmValue = "
                + parmValue + " size = " + size);
