...
public class OmacpParser {
    ...
    private void getEndTagData(OmacpParserData omacpParserData) {
        ...
        if (omacpParserData.mName.equalsIgnoreCase("CHARACTERISTIC")) {
            ...
            MTKlog.e(TAG, "OmacpParser omacpParserData.mType = " + omacpParserData.mType);
            MTKlog.e(TAG, "OmacpParser omacpParserData.mListType = " + omacpParserData.mListType);
    ...
    private int getEventType() {
        ...
        MTKlog.e(TAG, "OmacpParser getEventType = " + eventType);
        return eventType;
    }
