...
#ifdef CONFIG_EMULATION_EARLY_PORTING
# include "msdc_emu.h"
#else
...
#define TOP_CLKCTRL_BASE    0x10000000 //Temp, Please modify to reference system header.
#endif
...
#define __FPGA__
#endif
#define TOP_CLKCTRL_BASE    TOPCKGEN_BASE
#endif
...
#if !defined(IO_CONFIG_TOP_BASE)
#define IO_CONFIG_TOP_BASE      IO_CFG_TOP_BASE
#endif
#if !defined(IO_CONFIG_BOTTOM_BASE)
#define IO_CONFIG_BOTTOM_BASE   IO_CFG_BOTTOM_BASE
#endif
#if !defined(IO_CONFIG_LEFT_BASE)
#define IO_CONFIG_LEFT_BASE     IO_CFG_LEFT_BASE
#endif
...
/*--------------------------------------------------------------------------*/
#define CLK_MUX_SEL_ADDR        (TOP_CLKCTRL_BASE)
#define MSDC0_CLK_MUX_SEL       (7<<11)
#define MSDC1_CLK_MUX_SEL       (7<<20)

#define CLK_GATING_ADDR         (TOP_CLKCTRL_BASE + 0x24)
...
/* MSDC_PATCH_BIT mask */
//#define CKGEN_RX_SDClKO_SEL   (0x1    << 0)     /* This bit removed */
...
//#define MSDC_PATCH_BIT_CKGEN_CK (0x1  <<  6)    /* This bit removed (Only use internel clock) */
...
#define MSDC_PATCH_BIT_WDOD     (0xf    << 22)    /* RW */ //Removed
...
#define MSDC0_GPIO_MODE9_ADDR   (GPIO_base+0x0390)
#define MSDC0_GPIO_MODE10_ADDR  (GPIO_base+0x03A0)

#define MSDC0_DAT5_PINMUX_ADDR  (GPIO_base+0x0390)
#define MSDC0_DAT5_PINMUX_BITS  (7<<28)
#define MSDC0_DAT5_PINMUX_VAL   (1<<28)

#define MSDC0_DAT4_PINMUX_ADDR  (GPIO_base+0x0390)
#define MSDC0_DAT4_PINMUX_BITS  (7<<24)
#define MSDC0_DAT4_PINMUX_VAL   (1<<24)

#define MSDC0_DAT3_PINMUX_ADDR  (GPIO_base+0x0390)
#define MSDC0_DAT3_PINMUX_BITS  (7<<20)
#define MSDC0_DAT3_PINMUX_VAL   (1<<20)

#define MSDC0_DAT2_PINMUX_ADDR  (GPIO_base+0x0390)
#define MSDC0_DAT2_PINMUX_BITS  (7<<16)
#define MSDC0_DAT2_PINMUX_VAL   (1<<16)

#define MSDC0_DAT1_PINMUX_ADDR  (GPIO_base+0x0390)
#define MSDC0_DAT1_PINMUX_BITS  (7<<12)
#define MSDC0_DAT1_PINMUX_VAL   (1<<12)

#define MSDC0_DAT0_PINMUX_ADDR  (GPIO_base+0x0390)
#define MSDC0_DAT0_PINMUX_BITS  (7<<8)
#define MSDC0_DAT0_PINMUX_VAL   (1<<8)

#define MSDC0_CMD_PINMUX_ADDR   (GPIO_base+0x0390)
#define MSDC0_CMD_PINMUX_BITS   (7<<4)
#define MSDC0_CMD_PINMUX_VAL    (1<<4)

#define MSDC0_CLK_PINMUX_ADDR   (GPIO_base+0x0390)
#define MSDC0_CLK_PINMUX_BITS   (7<<0)
#define MSDC0_CLK_PINMUX_VAL    (1<<0)

#define MSDC0_RST_PINMUX_ADDR   (GPIO_base+0x03A0)
#define MSDC0_RST_PINMUX_BITS   (7<<8)
#define MSDC0_RST_PINMUX_VAL    (1<<8)

#define MSDC0_DAT7_PINMUX_ADDR  (GPIO_base+0x03A0)
#define MSDC0_DAT7_PINMUX_BITS  (7<<4)
#define MSDC0_DAT7_PINMUX_VAL   (1<<4)

#define MSDC0_DAT6_PINMUX_ADDR  (GPIO_base+0x03A0)
#define MSDC0_DAT6_PINMUX_BITS  (7<<0)
#define MSDC0_DAT6_PINMUX_VAL   (1<<0)

//GPIO25
#define MSDC1_INS1_PINMUX_ADDR  (GPIO_base+0x0330)
#define MSDC1_INS1_PINMUX_BITS  (7<<4)
#define MSDC1_INS1_PINMUX_VAL   (2<<4)

//GPIO34
#define MSDC1_INS2_PINMUX_ADDR  (GPIO_base+0x0340)
#define MSDC1_INS2_PINMUX_BITS  (7<<8)
#define MSDC1_INS2_PINMUX_VAL   (3<<8)

//GPIO36
#define MSDC1_INS3_PINMUX_ADDR  (GPIO_base+0x0340)
#define MSDC1_INS3_PINMUX_BITS  (7<<16)
#define MSDC1_INS3_PINMUX_VAL   (3<<16)

//GPIO68
#define MSDC1_INS4_PINMUX_ADDR  (GPIO_base+0x0380)
#define MSDC1_INS4_PINMUX_BITS  (7<<16)
#define MSDC1_INS4_PINMUX_VAL   (2<<16)

//GPIO118
#define MSDC1_INS5_PINMUX_ADDR  (GPIO_base+0x03E0)
#define MSDC1_INS5_PINMUX_BITS  (7<<24)
#define MSDC1_INS5_PINMUX_VAL   (2<<24)

//GPIO129
#define MSDC1_INS6_PINMUX_ADDR  (GPIO_base+0x0400)
#define MSDC1_INS6_PINMUX_BITS  (7<<4)
#define MSDC1_INS6_PINMUX_VAL   (5<<4)

//GPIO139
#define MSDC1_INS7_PINMUX_ADDR  (GPIO_base+0x0410)
#define MSDC1_INS7_PINMUX_BITS  (7<<12)
#define MSDC1_INS7_PINMUX_VAL   (4<<12)

#define MSDC1_CLK_PINMUX_ADDR   (GPIO_base+0x03A0)
#define MSDC1_CLK_PINMUX_BITS   (7<<12)
#define MSDC1_CLK_PINMUX_VAL    (1<<12)

#define MSDC1_CMD_PINMUX_ADDR   (GPIO_base+0x03A0)
#define MSDC1_CMD_PINMUX_BITS   (7<<16)
#define MSDC1_CMD_PINMUX_VAL    (1<<16)

#define MSDC1_DAT0_PINMUX_ADDR  (GPIO_base+0x03A0)
#define MSDC1_DAT0_PINMUX_BITS  (7<<20)
#define MSDC1_DAT0_PINMUX_VAL   (1<<20)

#define MSDC1_DAT1_PINMUX_ADDR  (GPIO_base+0x03A0)
#define MSDC1_DAT1_PINMUX_BITS  (7<<24)
#define MSDC1_DAT1_PINMUX_VAL   (1<<24)

#define MSDC1_DAT2_PINMUX_ADDR  (GPIO_base+0x03A0)
#define MSDC1_DAT2_PINMUX_BITS  (7<<28)
#define MSDC1_DAT2_PINMUX_VAL   (1<<28)

#define MSDC1_DAT3_PINMUX_ADDR  (GPIO_base+0x03B0)
...
#define MSDC0_IES_CLK           (0x1 << 0)
#define MSDC0_IES_CMD_RST       (0x1 << 1)
#define MSDC0_IES_DAT0_3        (0x1 << 2)
#define MSDC0_IES_DAT4_7        (0x1 << 3)
#define MSDC0_IES_ALL_MASK      (MSDC0_IES_CLK | MSDC0_IES_CMD_RST | MSDC0_IES_DAT0_3| MSDC0_IES_DAT4_7)
...
#define MSDC0_SR_CLK            (0x1 << 0)
#define MSDC0_SR_CMD_RST        (0x1 << 1)
#define MSDC0_SR_DAT0_3         (0x1 << 2)
#define MSDC0_SR_DAT4_7         (0x1 << 3)
#define MSDC0_SR_ALL_MASK       (MSDC0_SR_CLK | MSDC0_SR_CMD_RST | MSDC0_SR_DAT0_3| MSDC0_SR_DAT4_7)
...
#define MSDC0_SMT_CLK           (0x1 << 0)
#define MSDC0_SMT_CMD_RST       (0x1 << 1)
#define MSDC0_SMT_DAT0_3        (0x1 << 2)
#define MSDC0_SMT_DAT4_7        (0x1 << 3)
#define MSDC0_SMT_ALL_MASK      (MSDC0_SMT_CLK | MSDC0_SMT_CMD_RST | MSDC0_SMT_DAT0_3| MSDC0_SMT_DAT4_7)

#define MSDC0_TDSEL_BASE        (MSDC0_IO_CONFIG_BASE+0x0030)
#define MSDC0_RDSEL_BASE        (MSDC0_IO_CONFIG_BASE+0x0034)
#define MSDC0_TDSEL_CLK         (0xF  <<  4)
#define MSDC0_TDSEL_CMD_RST     (0xF  <<  8)
#define MSDC0_TDSEL_DAT0_3      (0xF  << 12)
#define MSDC0_TDSEL_DAT4_7      (0xF  << 16)
#define MSDC0_TDSEL_ALL_MASK    (0xFFFF << 4)
#define MSDC0_RDSEL_CLK         (0x3F <<  6)
#define MSDC0_RDSEL_CMD_RST     (0x3F << 12)
#define MSDC0_RDSEL_DAT0_3      (0x3F << 18)
#define MSDC0_RDSEL_DAT4_7      (0x3F << 24)
#define MSDC0_RDSEL_ALL_MASK    (0xFFFFFF << 6)
...
#define MSDC0_CLK_NO_PULL           (0x0 << 0)
#define MSDC0_CLK_PULL10K_EN        (0x1 << 0)
#define MSDC0_CLK_PULL50K_EN        (0x2 << 0)
#define MSDC0_CLK_PULL10K_50K_EN    (0x3 << 0)

#define MSDC0_CMD_NO_PULL           (0x0 << 2)
#define MSDC0_CMD_PULL10K_EN        (0x1 << 2)
#define MSDC0_CMD_PULL50K_EN        (0x2 << 2)
#define MSDC0_CMD_PULL10K_50K_EN    (0x3 << 2)

#define MSDC0_DAT0_NO_PULL          (0x0 << 4)
#define MSDC0_DAT0_PULL10K_EN       (0x1 << 4)
#define MSDC0_DAT0_PULL50K_EN       (0x2 << 4)
#define MSDC0_DAT0_PULL10K_50K_EN   (0x3 << 4)

#define MSDC0_DAT1_NO_PULL          (0x0 << 6)
#define MSDC0_DAT1_PULL10K_EN       (0x1 << 6)
#define MSDC0_DAT1_PULL50K_EN       (0x2 << 6)
#define MSDC0_DAT1_PULL10K_50K_EN   (0x3 << 6)

#define MSDC0_DAT2_NO_PULL          (0x0 << 8)
#define MSDC0_DAT2_PULL10K_EN       (0x1 << 8)
#define MSDC0_DAT2_PULL50K_EN       (0x2 << 8)
#define MSDC0_DAT2_PULL10K_50K_EN   (0x3 << 8)

#define MSDC0_DAT3_NO_PULL          (0x0 << 10)
#define MSDC0_DAT3_PULL10K_EN       (0x1 << 10)
#define MSDC0_DAT3_PULL50K_EN       (0x2 << 10)
#define MSDC0_DAT3_PULL10K_50K_EN   (0x3 << 10)

#define MSDC0_DAT4_NO_PULL          (0x0 << 12)
#define MSDC0_DAT4_PULL10K_EN       (0x1 << 12)
#define MSDC0_DAT4_PULL50K_EN       (0x2 << 12)
#define MSDC0_DAT4_PULL10K_50K_EN   (0x3 << 12)

#define MSDC0_DAT5_NO_PULL          (0x0 << 14)
#define MSDC0_DAT5_PULL10K_EN       (0x1 << 14)
#define MSDC0_DAT5_PULL50K_EN       (0x2 << 14)
#define MSDC0_DAT5_PULL10K_50K_EN   (0x3 << 14)

#define MSDC0_DAT6_NO_PULL          (0x0 << 16)
#define MSDC0_DAT6_PULL10K_EN       (0x1 << 16)
#define MSDC0_DAT6_PULL50K_EN       (0x2 << 16)
#define MSDC0_DAT6_PULL10K_50K_EN   (0x3 << 16)

#define MSDC0_DAT7_NO_PULL          (0x0 << 18)
#define MSDC0_DAT7_PULL10K_EN       (0x1 << 18)
#define MSDC0_DAT7_PULL50K_EN       (0x2 << 18)
#define MSDC0_DAT7_PULL10K_50K_EN   (0x3 << 18)

#define MSDC0_RST_NO_PULL           (0x0 << 20)
#define MSDC0_RST_PULL10K_EN        (0x1 << 20)
#define MSDC0_RST_PULL50K_EN        (0x2 << 20)
#define MSDC0_RST_PULL10K_50K_EN    (0x3 << 20)
...
#define MSDC0_CMD_RST_DRVING    (0x7  << 3)     /* RW */
#define MSDC0_DAT0_3_DRVING     (0x7  << 6)     /* RW */
#define MSDC0_DAT4_7_DRVING     (0x7  << 9)     /* RW */
#define MSDC0_DRVING_ALL_MASK   (MSDC0_CLK_DRVING | \
                                 MSDC0_CMD_RST_DRVING | \
                                 MSDC0_DAT0_3_DRVING | \
                                 MSDC0_DAT4_7_DRVING)
...
#define MSDC1_IES_CLK           (0x1 << 19)
#define MSDC1_IES_CMD           (0x1 << 20)
#define MSDC1_IES_DAT0_3        (0x1 << 21)
#define MSDC1_IES_ALL_MASK      (MSDC1_IES_CLK | MSDC1_IES_CMD | MSDC1_IES_DAT0_3)

#define MSDC1_SR_CFG_BASE       (MSDC1_IO_CONFIG_BASE+0x0020)
#define MSDC1_SR_CFG_SET        (MSDC1_IO_CONFIG_BASE+0x0024)
#define MSDC1_SR_CFG_CLR        (MSDC1_IO_CONFIG_BASE+0x0028)
#define MSDC1_SR_CLK            (0x1 << 10)
#define MSDC1_SR_CMD            (0x1 << 11)
#define MSDC1_SR_DAT0_3         (0x1 << 12)
#define MSDC1_SR_ALL_MASK       (MSDC1_SR_CLK | MSDC1_SR_CMD | MSDC1_SR_DAT0_3)

#define MSDC1_SMT_CFG_BASE      (MSDC1_IO_CONFIG_BASE+0x0040)
#define MSDC1_SMT_CFG_SET       (MSDC1_IO_CONFIG_BASE+0x0044)
#define MSDC1_SMT_CFG_CLR       (MSDC1_IO_CONFIG_BASE+0x0048)
#define MSDC1_SMT_CLK           (0x1 << 10)
#define MSDC1_SMT_CMD           (0x1 << 11)
#define MSDC1_SMT_DAT0_3        (0x1 << 12)
#define MSDC1_SMT_ALL_MASK      (MSDC1_SMT_CLK | MSDC1_SMT_CMD | MSDC1_SMT_DAT0_3)

#define MSDC1_TDSEL_BASE        (MSDC1_IO_CONFIG_BASE+0x0060)
#define MSDC1_RDSEL_BASE        (MSDC1_IO_CONFIG_BASE+0x0064)
#define MSDC1_TDSEL_CLK         (0xF  <<  0)
#define MSDC1_TDSEL_CMD         (0xF  <<  4)
#define MSDC1_TDSEL_DAT0_3      (0xF  <<  8)
#define MSDC1_TDSEL_ALL_MASK    (0xFFF << 0)
#define MSDC1_RDSEL_CLK         (0x3F <<  0)
#define MSDC1_RDSEL_CMD         (0x3F <<  6)
#define MSDC1_RDSEL_DAT0_3      (0x3F << 12)
#define MSDC1_RDSEL_ALL_MASK    (0x3FFFF << 0)

#define MSDC1_PULL_EN_CFG_BASE  (MSDC1_IO_CONFIG_BASE+0x0080)
#define MSDC1_PULL_EN_CFG_SET   (MSDC1_IO_CONFIG_BASE+0x0084)
#define MSDC1_PULL_EN_CFG_CLR   (MSDC1_IO_CONFIG_BASE+0x0088)
#define MSDC1_CLK_NO_PULL       (0x0 << 16)
#define MSDC1_CLK_PULL10K_EN    (0x1 << 16)
#define MSDC1_CLK_PULL50K_EN    (0x2 << 16)
#define MSDC1_CLK_PULL10K_50K_EN (0x3 << 16)

#define MSDC1_CMD_NO_PULL       (0x0 << 18)
#define MSDC1_CMD_PULL10K_EN    (0x1 << 18)
#define MSDC1_CMD_PULL50K_EN    (0x2 << 18)
#define MSDC1_CMD_PULL10K_50K_EN (0x3 << 18)

#define MSDC1_DAT0_NO_PULL      (0x0 << 20)
#define MSDC1_DAT0_PULL10K_EN   (0x1 << 20)
#define MSDC1_DAT0_PULL50K_EN   (0x2 << 20)
#define MSDC1_DAT0_PULL10K_50K_EN (0x3 << 20)

#define MSDC1_DAT1_NO_PULL      (0x0 << 22)
#define MSDC1_DAT1_PULL10K_EN   (0x1 << 22)
#define MSDC1_DAT1_PULL50K_EN   (0x2 << 22)
#define MSDC1_DAT1_PULL10K_50K_EN (0x3 << 22)

#define MSDC1_DAT2_NO_PULL      (0x0 << 24)
#define MSDC1_DAT2_PULL10K_EN   (0x1 << 24)
#define MSDC1_DAT2_PULL50K_EN   (0x2 << 24)
#define MSDC1_DAT2_PULL10K_50K_EN (0x3 << 24)

#define MSDC1_DAT3_NO_PULL      (0x0 << 26)
#define MSDC1_DAT3_PULL10K_EN   (0x1 << 26)
#define MSDC1_DAT3_PULL50K_EN   (0x2 << 26)
#define MSDC1_DAT3_PULL10K_50K_EN (0x3 << 26)
...
#define MSDC1_PULL_SEL_CFG_BASE (MSDC1_IO_CONFIG_BASE+0x00C0)
#define MSDC1_PULL_SEL_CFG_SET  (MSDC1_IO_CONFIG_BASE+0x00C4)
#define MSDC1_PULL_SEL_CFG_CLR  (MSDC1_IO_CONFIG_BASE+0x00C8)
...
#define MSDC1_DRVING_BASE       (MSDC1_IO_CONFIG_BASE+0x0110)
#define MSDC1_CLK_DRVING        (0x7 << 10)
#define MSDC1_CMD_DRVING        (0x7 << 13)
#define MSDC1_DAT0_3_DRVING     (0x7 << 16)
#define MSDC1_DRVING_ALL_MASK   (MSDC1_CLK_DRVING  | \
                                 MSDC1_CMD_DRVING  | \
                                 MSDC1_DAT0_3_DRVING)

#define MSDC1_DINV_DRVING_BASE  (MSDC1_IO_CONFIG_BASE+0x0150)
#define MSDC1_DINV_DRVING_SET   (MSDC1_IO_CONFIG_BASE+0x0154)
#define MSDC1_DINV_DRVING_CLR   (MSDC1_IO_CONFIG_BASE+0x0158)
...
//
// MSDC Driving Strength Definition
//
...
#endif //!CONFIG_EMULATION_EARLY_PORTING
