					...
					BOOL wdt_en )
{
	...
	if(wdt_en == TRUE)
		tmp_fast |= MTK_WDT_EN_FAST_ENABLE;
...
void mtk_wdt_mem_preserved_hw_reset(void)
{
    printf("UB WDT Dummy mtk_wdt_mem_preserved_hw_reset called\n");
}
void mtk_wdt_clear_mem_preserved_status(void)
{
    printf("UB WDT Dummy mtk_wdt_clear_mem_preserved_status called\n");
}

unsigned int mtk_wdt_is_mem_preserved(void)
{
		printf("UB WDT Dummy mtk_wdt_is_mem_preserved called\n");
    return FALSE;
}

unsigned int mtk_wdt_mem_preserved_is_enabled(void)
{
    printf("UB WDT Dummy mtk_wdt_mem_preserved_is_enabled called\n");
    return FALSE;
}

void mtk_wdt_presrv_mode_config(unsigned int ddr_resrv_en, unsigned int mcu_latch_en)
{
    printf("UB WDT Dummy mtk_wdt_presrv_mode_config called\n");
}
