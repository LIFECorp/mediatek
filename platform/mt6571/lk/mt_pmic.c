...
U32 pmic_read_interface (U32 RegNum, U32 *val, U32 MASK, U32 SHIFT)
{
    ...
    if(return_value!=0)
    {   
        printf("[pmic_read_interface] Reg[%x]= pmic_wrap read data fail, return_value=0x%x\n", RegNum, return_value);
        return return_value;
    }
...
U32 pmic_config_interface (U32 RegNum, U32 val, U32 MASK, U32 SHIFT)
{
    ...
    if(return_value!=0)
    {   
        printf("[pmic_config_interface] Reg[%x]= pmic_wrap read data fail, return_value=0x%x\n", RegNum, return_value);
        return return_value;
    }
...
int pmic_detect_powerkey(void)
{
    ...
    pmic_read_interface( (U32)(CHRSTATUS),
                             (&val),
