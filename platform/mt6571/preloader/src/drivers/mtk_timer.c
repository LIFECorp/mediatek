...
#define GPT4_MAX_US_TIMEOUT ((U32)715799249)    // 0xFFFFFFFF * 166.66ns / 1000
#define GPT4_MAX_MS_TIMEOUT ((U32)715799)       // 0xFFFFFFFF * 166.66ns / 1000000
#define GPT4_1US_TICK       ((U32)6)           // 1000 / 166.66ns = 6.000240
#define GPT4_1MS_TICK       ((U32)6000)        // 1000000 / 166.66ns = 6000.240
// 12MHz: 1us = 6.000 ticks
#define TIME_TO_TICK_US(us) ((us)*GPT4_1US_TICK + ((us)*0 + (1000-1))/1000)
// 12MHz: 1ms = 6000.240 ticks
#define TIME_TO_TICK_MS(ms) ((ms)*GPT4_1MS_TICK + ((ms)*240 + (1000-1))/1000)
#else
/*
