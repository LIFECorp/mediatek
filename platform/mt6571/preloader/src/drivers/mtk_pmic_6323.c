...
CHARGER_TYPE hw_charger_type_detection(void)
{
	...
	if(1 == hw_bc11_DCD())
	{
		 ...
		 if(1 == hw_bc11_stepA1())
		 {
			...
			PMIC_PRINT("step A1 : Apple 2.1A CHARGER!\r\n");
			 
			 }	 
		 else
		 {
            charger_tye = NONSTANDARD_CHARGER;
            PMIC_PRINT("step A1 : Non STANDARD CHARGER!\r\n");	 
		 }
	}
	else
	{
		 ...
		 if(1 == hw_bc11_stepA2())
		 {
			 ...
			 if(1 == hw_bc11_stepB2())
			 {
				 ...
				 PMIC_PRINT("step B2 : STANDARD CHARGER!\r\n");
			 }
			 else
			 {
				 charger_tye = CHARGING_HOST;
				 PMIC_PRINT("step B2 :  Charging Host!\r\n");
			 }
		 }
		 else
		 {
			 charger_tye = STANDARD_HOST;
			 PMIC_PRINT("step A2 : Standard USB Host!\r\n");
		 }
 
	}
 
    printf("[hw_charger_type_detection] type=%d\n", charger_tye);
	 /********* Finally setting *******************************/
	 hw_bc11_done();
#endif
	 return charger_tye;
...
CHARGER_TYPE mt_charger_type_detection(void)
{
    ...
    {
        printf("[mt_charger_type_detection] %d, %d\r\n", g_charger_in_flag, g_first_check);
    }
...
int pmic_detect_homekey(void)
{
    ...
    if (val==1){     
        printf("pl pmic homekey Release\n");
        return 0;
    }else{
        printf("pl pmic homekey Press\n");
        return 1;
    }
}
...
{    
    ...
    if(hw_charger_ov_flag == 1)
    {
        ...
        printf("pl chr ov turnoff charging\n"); 
        return;
    }
    ...
    switch(cc_val){
        ...
        default:
            PMIC_PRINT("hw_set_cc: arg invalid\r\n");
            break;
    }
