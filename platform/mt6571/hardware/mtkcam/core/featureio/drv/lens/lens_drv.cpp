...
#if defined(AD5823)
    err = ioctl(m_fdMCU,AD5823AFIOC_T_MOVETO,(unsigned long)a_i4FocusPos);
#else
...
#if defined(AD5823)
    stAD5823AF_MotorInfo motorInfo; 
    memset(&motorInfo, 0, sizeof(stAD5823AF_MotorInfo)); 
#else
...
#if defined(AD5823)
        err = ioctl(m_fdMCU,AD5823AFIOC_G_MOTORINFO, &motorInfo);
#else
...
#if defined(AD5823)
    err = ioctl(m_fdMCU,AD5823AFIOC_T_SETINFPOS,(unsigned long)a_i4FocusPos);
#else
...
#if defined(AD5823)
        err = ioctl(m_fdMCU,AD5823AFIOC_T_SETMACROPOS,(unsigned long)a_i4FocusPos);
#else
