...
/* start MT6571_SENINF_TOP_CODA.xml*/
...
/* end MT6571_SENINF_TOP_CODA.xml*/

/* start MT6571_SENINF_CODA.xml*/
typedef PACKING union
{
    PACKING struct
    {
...
/* end MT6571_SENINF_CODA.xml*/

/* start MT6571_SENINF_CSI2_CODA.xml*/
typedef PACKING union
{
    PACKING struct
    {
...
/* end MT6571_SENINF_CSI2_CODA.xml*/

/* start MT6571_SENINF_SCAM_CODA.xml*/
typedef PACKING union
{
    PACKING struct
    {
...
/* end MT6571_SENINF_SCAM_CODA.xml*/

/* start MT6571_SENINF_TG_CODA.xml*/
typedef PACKING union
{
    PACKING struct
    {
...
/* end MT6571_SENINF_TG_CODA.xml*/

/* start MT6571_SENINF_CCIR656_CODA.xml*/
typedef PACKING union
{
    PACKING struct
    {
...
/* end MT6571_SENINF_CCIR656_CODA.xml*/

/* start MT6571_ncsi2.xml*/
typedef PACKING union
{
    PACKING struct
    {
...
/* end MT6571_ncsi2.xml*/

// ----------------- seninf_top  Grouping Definitions -------------------
// ----------------- seninf_top Register Definition -------------------
typedef volatile struct _seninf_reg_t_
{
    //UINT32                          rsv_0000[2048];           // 0000..1FFC
    // SENINF_BASE_HW is 0x14012000
    REG_SENINF_TOP_CTRL             SENINF_TOP_CTRL;          // 2000 (start MT6571_SENINF_TOP_CODA.xml)
    UINT32                          rsv_2004[3];              // 2004..200C
    REG_SENINF1_CTRL                SENINF1_CTRL;             // 2010 (start MT6571_SENINF_CODA.xml)
    REG_SENINF1_INTEN               SENINF1_INTEN;            // 2014
    REG_SENINF1_INTSTA              SENINF1_INTSTA;           // 2018
    REG_SENINF1_SIZE                SENINF1_SIZE;             // 201C
    REG_SENINF1_DEBUG_1             SENINF1_DEBUG_1;          // 2020
    REG_SENINF1_DEBUG_2             SENINF1_DEBUG_2;          // 2024
    REG_SENINF1_DEBUG_3             SENINF1_DEBUG_3;          // 2028
    REG_SENINF1_DEBUG_4             SENINF1_DEBUG_4;          // 202C
    REG_SENINF1_DEBUG_5             SENINF1_DEBUG_5;          // 2030
    REG_SENINF1_DEBUG_6             SENINF1_DEBUG_6;          // 2034
    REG_SENINF1_DEBUG_7             SENINF1_DEBUG_7;          // 2038
    REG_SENINF1_SPARE               SENINF1_SPARE;            // 203C
    REG_SENINF1_DATA                SENINF1_DATA;             // 2040
    UINT32                          rsv_2044[47];             // 2044..20FC
    REG_SENINF1_CSI2_CTRL           SENINF1_CSI2_CTRL;        // 2100 (start MT6571_SENINF_CSI2_CODA.xml)
    REG_SENINF1_CSI2_DELAY          SENINF1_CSI2_DELAY;       // 2104
    REG_SENINF1_CSI2_INTEN          SENINF1_CSI2_INTEN;       // 2108
    REG_SENINF1_CSI2_INTSTA         SENINF1_CSI2_INTSTA;      // 210C
    REG_SENINF1_CSI2_ECCDBG         SENINF1_CSI2_ECCDBG;      // 2110
    REG_SENINF1_CSI2_CRCDBG         SENINF1_CSI2_CRCDBG;      // 2114
    REG_SENINF1_CSI2_DBG            SENINF1_CSI2_DBG;         // 2118
    REG_SENINF1_CSI2_VER            SENINF1_CSI2_VER;         // 211C
    REG_SENINF1_CSI2_SHORT_INFO     SENINF1_CSI2_SHORT_INFO;  // 2120
    REG_SENINF1_CSI2_LNFSM          SENINF1_CSI2_LNFSM;       // 2124
    REG_SENINF1_CSI2_LNMUX          SENINF1_CSI2_LNMUX;       // 2128
    REG_SENINF1_CSI2_HSYNC_CNT      SENINF1_CSI2_HSYNC_CNT;   // 212C
    REG_SENINF1_CSI2_CAL            SENINF1_CSI2_CAL;         // 2130
    REG_SENINF1_CSI2_DS             SENINF1_CSI2_DS;          // 2134
    REG_SENINF1_CSI2_VS             SENINF1_CSI2_VS;          // 2138
    REG_SENINF1_CSI2_BIST           SENINF1_CSI2_BIST;        // 213C
    UINT32                          rsv_2140[48];             // 2140..21FC
    REG_SCAM1_CFG                   SCAM1_CFG;                // 2200 (start MT6571_SENINF_SCAM_CODA.xml)
    REG_SCAM1_CON                   SCAM1_CON;                // 2204
    UINT32                          rsv_2208;                 // 2208
    REG_SCAM1_INT                   SCAM1_INT;                // 220C
    REG_SCAM1_SIZE                  SCAM1_SIZE;               // 2210
    UINT32                          rsv_2214[3];              // 2214..221C
    REG_SCAM1_CFG2                  SCAM1_CFG2;               // 2220
    UINT32                          rsv_2224[3];              // 2224..222C
    REG_SCAM1_INFO0                 SCAM1_INFO0;              // 2230
    REG_SCAM1_INFO1                 SCAM1_INFO1;              // 2234
    UINT32                          rsv_2238[2];              // 2238..223C
    REG_SCAM1_STA                   SCAM1_STA;                // 2240
    UINT32                          rsv_2244[47];             // 2244..22FC
    REG_TG1_PH_CNT                  SENINF_TG1_PH_CNT;        // 2300 (start MT6571_SENINF_TG_CODA.xml)
    REG_TG1_SEN_CK                  SENINF_TG1_SEN_CK;        // 2304
    REG_TG1_TM_CTL                  SENINF_TG1_TM_CTL;        // 2308
    REG_TG1_TM_SIZE                 SENINF_TG1_TM_SIZE;       // 230C
    REG_TG1_TM_CLK                  SENINF_TG1_TM_CLK;        // 2310
    UINT32                          rsv_2314[59];             // 2314..23FC
    REG_CCIR656_CTL                 CCIR656_CTL;              // 2400 (start MT6571_SENINF_CCIR656_CODA.xml)
    REG_CCIR656_H                   CCIR656_H;                // 2404
    REG_CCIR656_PTGEN_H_1           CCIR656_PTGEN_H_1;        // 2408
    REG_CCIR656_PTGEN_H_2           CCIR656_PTGEN_H_2;        // 240C
    REG_CCIR656_PTGEN_V_1           CCIR656_PTGEN_V_1;        // 2410
    REG_CCIR656_PTGEN_V_2           CCIR656_PTGEN_V_2;        // 2414
    REG_CCIR656_PTGEN_CTL1          CCIR656_PTGEN_CTL1;       // 2418
    REG_CCIR656_PTGEN_CTL2          CCIR656_PTGEN_CTL2;       // 241C
    REG_CCIR656_PTGEN_CTL3          CCIR656_PTGEN_CTL3;       // 2420
    REG_CCIR656_STATUS              CCIR656_STATUS;           // 2424
    UINT32                          rsv_2428[118];            // 2428..25FC
    REG_SENINF1_NCSI2_CTL           SENINF1_NCSI2_CTL;        // 2600
    REG_SENINF1_NCSI2_LNRC_TIMING   SENINF1_NCSI2_LNRC_TIMING; // 2604
    REG_SENINF1_NCSI2_LNRD_TIMING   SENINF1_NCSI2_LNRD_TIMING; // 2608
    REG_SENINF1_NCSI2_DPCM          SENINF1_NCSI2_DPCM;       // 260C
    REG_SENINF1_NCSI2_VC            SENINF1_NCSI2_VC;         // 2610
    REG_SENINF1_NCSI2_INT_EN        SENINF1_NCSI2_INT_EN;     // 2614
    REG_SENINF1_NCSI2_INT_STATUS    SENINF1_NCSI2_INT_STATUS; // 2618
    REG_SENINF1_NCSI2_DGB_SEL       SENINF1_NCSI2_DGB_SEL;    // 261C
    REG_SENINF1_NCSI2_DBG_PORT      SENINF1_NCSI2_DBG_PORT;   // 2620
    REG_SENINF1_NCSI2_LNRC_FSM      SENINF1_NCSI2_LNRC_FSM;   // 2624
    REG_SENINF1_NCSI2_LNRD_FSM      SENINF1_NCSI2_LNRD_FSM;   // 2628
    REG_SENINF1_NCSI2_FRAME_LINE_NUM SENINF1_NCSI2_FRAME_LINE_NUM; // 262C
    REG_SENINF1_NCSI2_GENERIC_SHORT SENINF1_NCSI2_GENERIC_SHORT; // 2630
    UINT32                          rsv_2634[3];              // 2634..263C
    REG_SENINF1_NCSI2_SPARE0        SENINF1_NCSI2_SPARE0;     // 2640
    REG_SENINF1_NCSI2_SPARE1        SENINF1_NCSI2_SPARE1;     // 2644
}seninf_reg_t;
