...
#ifndef _MTK_GD_ERRCODE_H
#define _MTK_GD_ERRCODE_H
...
#define MODULE_MTK_GD (0) // Temp value

#define MTKGD_OKCODE(errid)         OKCODE(MODULE_MTK_GD, errid)
#define MTKGD_ERRCODE(errid)        ERRCODE(MODULE_MTK_GD, errid)


// Detection error code
#define S_GD_OK                  MTKGD_OKCODE(0x0000)     

#define E_GD_NEED_OVER_WRITE     MTKGD_ERRCODE(0x0001)
#define E_GD_NULL_OBJECT         MTKGD_ERRCODE(0x0002)
#define E_GD_WRONG_STATE         MTKGD_ERRCODE(0x0003)
#define E_GD_WRONG_CMD_ID        MTKGD_ERRCODE(0x0004)
#define E_GD_WRONG_CMD_PARAM     MTKGD_ERRCODE(0x0005)
#define E_GD_Driver_Fail         MTKGD_ERRCODE(0x0010)

#define E_GD_ERR                 MTKGD_ERRCODE(0x0100)
