...
//    #define __ISP_USE_LUT_MAP_PHYMEM__
//    #define __ISP_USE_PMEM__
#endif
/*=================================================================================
...
class IMemDrv
{
    ...
    public:
        ...
        virtual MINT32  mapPhyAddr(IMEM_BUF_INFO* pInfo
#if defined(__ISP_USE_LUT_MAP_PHYMEM__)
            , bool bLookUp = 0 
            , bool bInsertItem = 0
#endif
            ) = 0;
        virtual MINT32  unmapPhyAddr(IMEM_BUF_INFO* pInfo
#if defined(__ISP_USE_LUT_MAP_PHYMEM__)
            , bool bLookUp = 0 
            , bool bEraseItem = 0
#endif
...
#if defined(__ISP_USE_LUT_MAP_PHYMEM__)
        //virtual MINT32  lookUpPhyAddr(MUINT32 u4VA) = 0;
		virtual MBOOL  lookUpPhyAddr(MUINT32 u4VA, MUINT32* u4PA, int* index) = 0;
        virtual MBOOL  unmapAllPhyAddr(void) = 0;
#endif
};
//----------------------------------------------------------------------------
#endif  // _IMEM_DRV_H_
