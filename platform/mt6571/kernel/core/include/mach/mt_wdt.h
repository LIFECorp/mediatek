...
#define MTK_WDT_EN_FAST				(MTK_WDT_BASE+0x0400)
#define MTK_WDT_RESTART_FAST			(MTK_WDT_BASE+0x0404)
#define MTK_WDT_FAST_SWSYSRST			(MTK_WDT_BASE+0x0408)
#define MTK_WDT_FAST_NONRST_REG		(MTK_WDT_BASE+0x0410)
#define MTK_WDT_FAST_NONRST_REG2	(MTK_WDT_BASE+0x0414)
...
/*WDT_EN_FAST*/
#define MTK_WDT_EN_FAST_KEY				(0x22000000)
#define MTK_WDT_EN_FAST_ENABLE		(0x0001)

/*WDT_RESTART_FAST*/
#define MTK_WDT_RESTART_FAST_KEY		(0x1971)

/*WDT_FAST_SWSYSRST*/
#define MTK_WDT_FAST_SWSYS_RST_PWRAP_SPI_CTL_RST	(0x0800)
#define MTK_WDT_FAST_SWSYS_RST_APMIXED_RST	(0x0400)
#define MTK_WDT_FAST_SWSYS_RST_MD_LITE_RST	(0x0200)
#define MTK_WDT_FAST_SWSYS_RST_INFRA_AO_RST	(0x0100)
#define MTK_WDT_FAST_SWSYS_RST_MD_RST	(0x0080)
#define MTK_WDT_FAST_SWSYS_RST_DDRPHY_RST	(0x0040)
#define MTK_WDT_FAST_SWSYS_RST_IMG_RST	(0x0020)
#define MTK_WDT_FAST_SWSYS_RST_VDEC_RST	(0x0010)
#define MTK_WDT_FAST_SWSYS_RST_VENC_RST	(0x0008)
#define MTK_WDT_FAST_SWSYS_RST_MFG_RST	(0x0004)
#define MTK_WDT_FAST_SWSYS_RST_DISP_RST	(0x0002)
#define MTK_WDT_FAST_SWSYS_RST_INFRA_RST	(0x0001)
#define MTK_WDT_FAST_SWSYS_RST_KEY		(0x88000000)
