...
#define  SPM_CURRENT_FREE_RUN_CNT    (SPM_BASE + 0x0774)
#define  SPM_CURRENT_IDLE_CNT0       (SPM_BASE + 0x0778)
#define  SPM_CURRENT_IDLE_CNT1       (SPM_BASE + 0x077C)
...
#endif
wake_reason_t spm_go_to_normal(void); //used to kick normal.
wake_reason_t spm_stop_normal(void);//used to enable/disable spm normal.



extern char* spm_parse_twam_record(wake_status_t* wake_status_p, char *p);
