...
#define EMI_GENA (EMI_BASE+0x0070)
...
#define PERI_AHB_LYR0_MASTER (INFRA_SYS_CFG_BASE+0x0400)
#define PERI_AHB_LYR1_MASTER (INFRA_SYS_CFG_BASE+0x0404)
#define PERI_AHB_LYR3_MASTER (INFRA_SYS_CFG_BASE+0x0408)
