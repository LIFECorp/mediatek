...
#define INTEN_FLD_OVL_FME_HWRST_DONE_INTEN                     REG_FLD(1, 4)
...
#define INTSTA_FLD_OVL_FME_HWRST_DONE_INTSTA                   REG_FLD(1, 4)
...
#define L0_CON_FLD_INT_MTX_SEL                                 REG_FLD(4, 16)
...
#define L1_CON_FLD_INT_MTX_SEL                                 REG_FLD(4, 16)
...
#define L2_CON_FLD_INT_MTX_SEL                                 REG_FLD(4, 16)
...
#define L3_CON_FLD_INT_MTX_SEL                                 REG_FLD(4, 16)
