...
int OVLLayerConfig(unsigned int layer,
    ...
    if (fmt == OVL_INPUT_FORMAT_PARGB8888)
    {
        if ((aen == TRUE) && (alpha == 0))
            aen = FALSE;
    }
    ...
    switch(layer) {
        case 0:
            ...
            DISP_REG_SET_FIELD(L0_CON_FLD_INT_MTX_SEL, DISP_REG_OVL_L0_CON, matrix_transform);
        ...
        case 1:
            ...
            DISP_REG_SET_FIELD(L1_CON_FLD_INT_MTX_SEL, DISP_REG_OVL_L1_CON, matrix_transform);
        ...
        case 2:
            ...
            DISP_REG_SET_FIELD(L2_CON_FLD_INT_MTX_SEL, DISP_REG_OVL_L2_CON, matrix_transform);
        ...
        case 3:
            ...
            DISP_REG_SET_FIELD(L3_CON_FLD_INT_MTX_SEL, DISP_REG_OVL_L3_CON, matrix_transform);
