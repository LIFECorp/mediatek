...
extern void MET_LM_Enable(const unsigned int enable);
extern unsigned int MET_LM_IsOverrun(void);
extern int MET_LM_SetMaster(const unsigned int master);
extern int MET_LM_GetWTransCount(void);
extern int MET_LM_GetWLatCount(void);
extern int MET_LM_GetRTransCount(void);
extern int MET_LM_GetRLatCount(void);
