...
static unsigned int uart_base[]={UART1_BASE_ADDR, UART2_BASE_ADDR};
static unsigned int vff_tx_base[]={VFF_TX1_BASE_ADDR, VFF_TX2_BASE_ADDR};
static unsigned int vff_rx_base[]={VFF_RX1_BASE_ADDR, VFF_RX2_BASE_ADDR};
//static unsigned int uart_irq_num[]={UART1_IRQ_ID, UART2_IRQ_ID};
...
static int __init uart_udvt_mod_init(void)
{
	...
	*((volatile u32*)(0xF00053bc)) = 0x90000000;
	*((volatile u32*)(0xF00053cc)) = 0x9;

	if(!spm_wakesrc_set(SPM_PCM_DEEP_IDLE,WAKE_ID_UART0))
	{
        	return false;//Error Invalid Wake Source
	}
