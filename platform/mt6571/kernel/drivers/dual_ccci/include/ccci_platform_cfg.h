...
//#define  ENABLE_LOCK_MD_SLP_FEATURE  // Only used for Workaround form MT6575/77
...
#define MD_CCIF_ACK(base)		((base) + 0x134)
...
#define MD_DEBUG_MODE				(0xF000142C)
