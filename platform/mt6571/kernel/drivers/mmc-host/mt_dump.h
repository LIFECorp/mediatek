...
struct simp_mmc_host {
    ...
    unsigned int        ocr_avail_sdio; /* SDIO-specific OCR */
    unsigned int        ocr_avail_sd;   /* SD-specific OCR */
    unsigned int        ocr_avail_mmc;  /* MMC-specific OCR */
    ...
    unsigned int        ocr;            /* the current OCR setting */
...
struct simp_mmc_card {
    ...
    unsigned char       erased_byte;    /* value of erased bytes */

    unsigned int        raw_cid[4];     /* raw card CID */
    unsigned int        raw_csd[4];     /* raw card CSD */
    unsigned int        raw_scr[2];     /* raw card SCR */
