...
#define MSDC1_IRQ_SEL       (1 << 9)     //Un-used
#define PDN_REG             (0xF1000010) //Un-used
...
#if 0
//Declare and enable early_suspend and late_resume callback function only when something shall be done in these 2 functions
...
u32 msdc_dump_padctl0(u32 id)
{
    ...
    switch(id){
        case 0:
            sdr_get_field(MSDC0_RDSEL_BASE, MSDC0_RDSEL_CLK, tmp);
            reg |= tmp << 24;
            sdr_get_field(MSDC0_TDSEL_BASE, MSDC0_TDSEL_CLK, tmp);
            reg |= tmp << 20;
            sdr_get_field(MSDC0_IES_CFG_BASE, MSDC0_IES_CLK, tmp);
            reg |= tmp << 19;
            sdr_get_field(MSDC0_SMT_CFG_BASE, MSDC0_SMT_CLK, tmp);
            reg |= tmp << 18;
            sdr_get_field(MSDC0_PULL_EN_CFG_BASE, MSDC0_CLK_PULL10K_50K_EN, tmp);
            reg |= tmp << 16;
            sdr_get_field(MSDC0_PULL_SEL_CFG_BASE, MSDC0_CLK_PULL_SEL, tmp);
            reg |= tmp << 15;
            sdr_get_field(MSDC0_SR_CFG_BASE, MSDC0_SR_CLK, tmp);
            reg |= tmp << 8;
            sdr_get_field(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, tmp);
            reg |= tmp << 4;
            reg |= tmp << 0;
            break;

        case 1:
            sdr_get_field(MSDC1_RDSEL_BASE, MSDC1_RDSEL_CLK, tmp);
            reg |= tmp << 24;
            sdr_get_field(MSDC1_TDSEL_BASE, MSDC1_TDSEL_CLK, tmp);
            reg |= tmp << 20;
            sdr_get_field(MSDC1_IES_CFG_BASE, MSDC1_IES_CLK, tmp);
            reg |= tmp << 19;
            sdr_get_field(MSDC1_SMT_CFG_BASE, MSDC1_SMT_CLK, tmp);
            reg |= tmp << 18;
            sdr_get_field(MSDC1_PULL_EN_CFG_BASE, MSDC1_CLK_PULL10K_50K_EN, tmp);
            reg |= tmp << 16;
            sdr_get_field(MSDC1_PULL_SEL_CFG_BASE, MSDC1_CLK_PULL_SEL, tmp);
            reg |= tmp << 15;
            sdr_get_field(MSDC1_SR_CFG_BASE, MSDC1_SR_CLK, tmp);
            reg |= tmp << 8;
            sdr_get_field(MSDC1_DRVING_BASE, MSDC1_CLK_DRVING, tmp);
            reg |= tmp << 4;
            reg |= tmp << 0;
            break;
        default:
...
u32 msdc_dump_padctl1(u32 id)
{
    ...
    switch(id){
        case 0:
            sdr_get_field(MSDC0_RDSEL_BASE, MSDC0_RDSEL_CMD_RST, tmp);
            reg |= tmp << 24;
            sdr_get_field(MSDC0_TDSEL_BASE, MSDC0_TDSEL_CMD_RST, tmp);
            reg |= tmp << 20;
            sdr_get_field(MSDC0_IES_CFG_BASE, MSDC0_IES_CMD_RST, tmp);
            reg |= tmp << 19;
            sdr_get_field(MSDC0_SMT_CFG_BASE, MSDC0_SMT_CMD_RST, tmp);
            reg |= tmp << 18;
            sdr_get_field(MSDC0_PULL_EN_CFG_BASE, MSDC0_CMD_PULL10K_50K_EN, tmp);
            reg |= tmp << 16;
            sdr_get_field(MSDC0_PULL_SEL_CFG_BASE, MSDC0_CMD_PULL_SEL, tmp);
            reg |= tmp << 15;
            sdr_get_field(MSDC0_SR_CFG_BASE, MSDC0_SR_CMD_RST, tmp);
            reg |= tmp << 8;
            sdr_get_field(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DRVING, tmp);
            reg |= tmp << 4;
            reg |= tmp << 0;
            break;

        case 1:
            sdr_get_field(MSDC1_RDSEL_BASE, MSDC1_RDSEL_CMD, tmp);
            reg |= tmp << 24;
            sdr_get_field(MSDC1_TDSEL_BASE, MSDC1_TDSEL_CMD, tmp);
            reg |= tmp << 20;
            sdr_get_field(MSDC1_IES_CFG_BASE, MSDC1_IES_CMD, tmp);
            reg |= tmp << 19;
            sdr_get_field(MSDC1_SMT_CFG_BASE, MSDC1_SMT_CMD, tmp);
            reg |= tmp << 18;
            sdr_get_field(MSDC1_PULL_EN_CFG_BASE, MSDC1_CMD_PULL10K_50K_EN, tmp);
            reg |= tmp << 16;
            sdr_get_field(MSDC1_PULL_SEL_CFG_BASE, MSDC1_CMD_PULL_SEL, tmp);
            reg |= tmp << 15;
            sdr_get_field(MSDC1_SR_CFG_BASE, MSDC1_SR_CMD, tmp);
            reg |= tmp << 8;
            sdr_get_field(MSDC1_DRVING_BASE, MSDC1_CMD_DRVING, tmp);
            reg |= tmp << 4;
            reg |= tmp << 0;
            break;
...
u32 msdc_dump_padctl2(u32 id)
{
    ...
    switch(id){
        case 0:
            sdr_get_field(MSDC0_RDSEL_BASE, MSDC0_RDSEL_DAT0_3, tmp);
            reg |= tmp << 24;
            sdr_get_field(MSDC0_TDSEL_BASE, MSDC0_TDSEL_DAT0_3, tmp);
            reg |= tmp << 20;
            sdr_get_field(MSDC0_IES_CFG_BASE, MSDC0_IES_DAT0_3, tmp);
            reg |= tmp << 19;
            sdr_get_field(MSDC0_SMT_CFG_BASE, MSDC0_SMT_DAT0_3, tmp);
            reg |= tmp << 18;
            sdr_get_field(MSDC0_PULL_EN_CFG_BASE, MSDC0_DAT0_PULL10K_50K_EN, tmp);
            reg |= tmp << 16;
            sdr_get_field(MSDC0_PULL_SEL_CFG_BASE, MSDC0_DAT0_PULL_SEL, tmp);
            reg |= tmp << 15;
            sdr_get_field(MSDC0_SR_CFG_BASE, MSDC0_SR_DAT0_3, tmp);
            reg |= tmp << 8;
            sdr_get_field(MSDC0_DRVING_BASE, MSDC0_DAT0_3_DRVING, tmp);
            reg |= tmp << 4;
            reg |= tmp << 0;
            break;

        case 1:
            sdr_get_field(MSDC1_RDSEL_BASE, MSDC1_RDSEL_DAT0_3, tmp);
            reg |= tmp << 24;
            sdr_get_field(MSDC1_TDSEL_BASE, MSDC1_TDSEL_DAT0_3, tmp);
            reg |= tmp << 20;
            sdr_get_field(MSDC1_IES_CFG_BASE, MSDC1_IES_DAT0_3, tmp);
            reg |= tmp << 19;
            sdr_get_field(MSDC1_SMT_CFG_BASE, MSDC1_SMT_DAT0_3, tmp);
            reg |= tmp << 18;
            sdr_get_field(MSDC1_PULL_EN_CFG_BASE, MSDC1_DAT0_PULL10K_50K_EN, tmp);
            reg |= tmp << 16;
            sdr_get_field(MSDC1_PULL_SEL_CFG_BASE, MSDC1_DAT0_PULL_SEL, tmp);
            reg |= tmp << 15;
            sdr_get_field(MSDC1_SR_CFG_BASE, MSDC1_SR_DAT0_3, tmp);
            reg |= tmp << 8;
            sdr_get_field(MSDC1_DRVING_BASE, MSDC1_DAT0_3_DRVING, tmp);
            reg |= tmp << 4;
            reg |= tmp << 0;
            break;
...
static void msdc_dump_register(struct msdc_host *host)
{
    ...
    INIT_MSG("Reg[A4] DMA_LEN        = 0x%.8x", sdr_read32(base + 0xA8));
...
static void msdc_pin_pud(struct msdc_host *host, int mode)
{
    switch(host->id){
            if (mode) {
                ...
                sdr_set_field(MSDC0_PULL_SEL_CFG_BASE, MSDC0_PULL_SEL_ALL_MASK, 0x3FE);
            } else {
            ...
            sdr_write32(MSDC0_PULL_EN_CFG_SET, 0x255556);
            break;
        case 1:
            if (mode) {
            ...
            sdr_write32(MSDC1_PULL_EN_CFG_SET, MSDC1_PULL_EN_ALL_MASK);
            break;
...
static void msdc_pin_pnul(struct msdc_host *host, int mode)
{
    switch(host->id){
        case 1:
            if ( !mode )
                sdr_write32(MSDC1_PULL_EN_CFG_CLR, MSDC1_PULL_EN_ALL_MASK);
            break;
        default:
            break;
    }
...
void msdc_set_sr(struct msdc_host *host,int clk,int cmd, int dat)
{
    switch(host->id){
        case 0:
            sdr_set_field(MSDC0_SR_CFG_BASE, MSDC0_SR_CLK, clk);
            sdr_set_field(MSDC0_SR_CFG_BASE, MSDC0_SR_CMD_RST, cmd);
            sdr_set_field(MSDC0_SR_CFG_BASE, MSDC0_SR_DAT0_3, dat);
            sdr_set_field(MSDC0_SR_CFG_BASE, MSDC0_SR_DAT4_7, dat);
            break;
        case 1:
            sdr_set_field(MSDC1_SR_CFG_BASE, MSDC1_SR_CLK, clk);
            sdr_set_field(MSDC1_SR_CFG_BASE, MSDC1_SR_CMD, cmd);
            sdr_set_field(MSDC1_SR_CFG_BASE, MSDC1_SR_DAT0_3, dat);
            break;
        default:
            break;
    }
...
void msdc_set_rdtdsel(struct msdc_host *host,bool sd_18)
{
    switch(host->id){
        case 0:
            if(sd_18){
                sdr_set_field(MSDC0_TDSEL_BASE, MSDC0_TDSEL_ALL_MASK ,0xaaaa);
                sdr_set_field(MSDC0_RDSEL_BASE, MSDC0_RDSEL_ALL_MASK ,0x0);
            } else{
                sdr_set_field(MSDC0_TDSEL_BASE, MSDC0_TDSEL_ALL_MASK ,0xaaaa);
                sdr_set_field(MSDC0_RDSEL_BASE, MSDC0_RDSEL_ALL_MASK ,0x30c30c);
            }
            break;
        case 1:
            if(sd_18){
                sdr_set_field(MSDC1_TDSEL_BASE, MSDC1_TDSEL_ALL_MASK ,0xaaa);
                sdr_set_field(MSDC1_RDSEL_BASE, MSDC1_RDSEL_ALL_MASK ,0x0);
            } else{
                sdr_set_field(MSDC1_TDSEL_BASE, MSDC1_TDSEL_ALL_MASK ,0xaaa);
                sdr_set_field(MSDC1_RDSEL_BASE, MSDC1_RDSEL_ALL_MASK ,0xc30c);
            }
            break;
        default:
            break;
...
void msdc_set_driving(struct msdc_host *host,struct msdc_hw *hw,bool sd_18)
{
    switch(host->id){
        case 0:
            if ( sd_18 ) {
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, hw->clk_drv_sd_18);
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DRVING, hw->cmd_drv_sd_18);
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_DAT0_3_DRVING, hw->dat_drv_sd_18);
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_DAT4_7_DRVING, hw->dat_drv_sd_18);
            } else {
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_CLK_DRVING, hw->clk_drv);
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_CMD_RST_DRVING, hw->cmd_drv);
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_DAT0_3_DRVING, hw->dat_drv);
                sdr_set_field(MSDC0_DRVING_BASE, MSDC0_DAT4_7_DRVING, hw->dat_drv);
            }
            break;
        case 1:
            if ( sd_18 ) {
...
void msdc_set_pad_init(struct msdc_host *host)
{
    switch (host->id) {
        ...
        case 0:
            ...
            //
            sdr_set_field(MSDC0_PULL_EN_CFG_BASE, MSDC0_PULL_EN_ALL_MASK, 0x255556);
            ...
            //
            sdr_set_field(MSDC0_GPIO_MODE9_ADDR,
            ...
            //
            // set msdc mode. (MC0_RST, MC0_DAT6, MC0_DAT7)
            //
            sdr_set_field(MSDC0_GPIO_MODE10_ADDR,
                     MSDC0_RST_PINMUX_BITS | MSDC0_DAT7_PINMUX_BITS | MSDC0_DAT6_PINMUX_BITS ,
                     0x111);
            break;

        case 1:
            sdr_write32(MSDC1_IES_CFG_SET, MSDC1_IES_ALL_MASK); //Cool's solution for SD card: Enable IES bit
            ...
            //
            // set gpio to msdc mode. (cmd/dat0/dat1/dat2 in GPIO_MODE10)
            sdr_set_field(MSDC1_CMD_PINMUX_ADDR,
                    MSDC1_CMD_PINMUX_BITS |
                    MSDC1_DAT0_PINMUX_BITS | MSDC1_DAT1_PINMUX_BITS | MSDC1_DAT2_PINMUX_BITS, 0x1111);

            //
            // set gpio to msdc mode. (dat3 in GPIO_MODE11)
            sdr_set_field(MSDC1_DAT3_PINMUX_ADDR, MSDC1_DAT3_PINMUX_BITS, 0x1);

            // Set CLK pinmux after all other pinmux have been set
            // set gpio to msdc mode. (clk in GPIO_MODE10)
            sdr_set_field(MSDC1_CLK_PINMUX_ADDR, MSDC1_CLK_PINMUX_BITS, 0x1);
...
static void msdc_sd_power(struct msdc_host *host,u32 on)
{
    ...
    switch(host->id){
        case 1:
            ...
            if (PMIC_APP_MEMORY_CARD_VDD == MT6323_POWER_LDO_DEFAULT) {
                msdc_ldo_power(on, MT6323_POWER_LDO_VMCH, VOL_3300, &g_msdc1_flash);
            }
            else {
                msdc_ldo_power(on, PMIC_APP_MEMORY_CARD_VDD, VOL_3300, &g_msdc1_flash);
            }
...
#if defined(CFG_DEV_MSDC2) || defined(CFG_DEV_MSDC3)
...
{
    cg_clk_id clk_id=MT_CG_MPLL_D8;
    clkmux_id mux_id=MT_CLKMUX_MSDC1_MUX_SEL;
    char name[6];
...
static u32 msdc_power_tuning(struct msdc_host *host)
{
    ...
    if ( mmc_card_sd(card) && (host->hw->host_function == MSDC_SD) ) {
        ...
        if ( (host->power_cycle < MSDC_MAX_POWER_CYCLE) && (host->power_cycle_enable) ) {
            ...
            sdr_get_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_GET_BUSY_MARGIN, host->saved_para.write_timeout_eco1);
            //for write: host check timeout change to 16T */
            sdr_get_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_GET_CRC_MARGIN, host->saved_para.write_timeout_eco2);
...
static void msdc_set_power_mode(struct msdc_host *host, u8 mode)
{
    ...
    if (host->power_mode == MMC_POWER_OFF && mode != MMC_POWER_OFF) {
        //To Do: Consider if can be comment for safty bring-0up
...
static void msdc_restore_emmc_setting(struct msdc_host *host)
{
    ...
    //for write: 3T need wait before host check busy after crc status
    sdr_set_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_GET_BUSY_MARGIN, host->saved_para.write_timeout_eco1);
    //for write: host check timeout change to 16T */
    sdr_set_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_GET_CRC_MARGIN, host->saved_para.write_timeout_eco2);
}
...
static int msdc_dma_config(struct msdc_host *host, struct msdc_dma *dma)
{
    ...
    N_MSG(DMA, "DMA_LEN  = 0x%x", sdr_read32(MSDC_DMA_LEN));
...
static int msdc_do_request_async(struct mmc_host*mmc, struct mmc_request*mrq)
{
    ...
    N_MSG(OPS, "CMD<%d> data<%s %s> blksz<%d> block<%d> error<%d>",cmd->opcode, (host->dma_xfer? "dma":"pio"),
            (read ? "read ":"write") ,data->blksz, data->blocks, data->error);
        ...
        if (data && (data->error == (unsigned int)-ETIMEDOUT)) {
            if (data->flags & MMC_DATA_READ) {
                if( !(host->sw_timeout) &&
                    ...
                    if (!mmc_card_uhs(host->mmc->card)) {
                        #ifdef MSDC_LOWER_FREQ
                        if (host->power_cycle > 1)
                            msdc_lower_freq(host);
                        #endif
                        host->hw->clk_drv = 3;
                        host->hw->cmd_drv = 3;
                        host->hw->dat_drv = 3;
                        ERR_MSG("msdc drving<clk %d,cmd %d,dat %d>",host->hw->clk_drv, host->hw->cmd_drv, host->hw->dat_drv);
                        msdc_set_driving(host, host->hw, 0);
                    }
                }
            }
...
static void msdc_ops_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
{
    ...
    if(msdc_host_mode[host->id] != mmc->caps)
    {
        ...
        //Kaikai Yu: set bit7 and bit6 no matter SD, SDIO , or EMMC is used
    ...
    if (host->mclk != ios->clock || host->ddr != ddr) { /* not change when clock Freq. not changed ddr need set clock*/
        ...
        if (ios->clock == 0) {
            ...
            sdr_set_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_WRDAT_CRCS,1);
            //Kaikai Yu: set bit7 and bit6 no matter SD, SDIO , or EMMC is used
            sdr_set_field(MSDC_PATCH_BIT1, MSDC_PATCH_BIT1_GET_BUSY_MARGIN, 1);
...
static void msdc_init_hw(struct msdc_host *host)
{
    ...
    if (!is_card_sdio(host)) {  /* internal clock: latch read data, not apply to sdio */
        //sdr_set_bits(MSDC_PATCH_BIT0, MSDC_PATCH_BIT_CKGEN_CK);//No feedback clock, only internal clock
        host->hw->cmd_edge  = 0; // tuning from 0
        host->hw->rdata_edge = 0;
        host->hw->wdata_edge = 0;
    }else if (hw->flags & MSDC_INTERNAL_CLK) {
