...
#define MSDC_DESENSE_REG    (0xf0007070)    //Seems unused
...
#define MSDC_PATCH_BIT1_GET_BUSY_MARGIN (0x7 << 6)
#define MSDC_PATCH_BIT1_GET_CRC_MARGIN  (0x7 << 7)
...
#define MSDC0_IO_CONFIG_BASE    (IO_CFG_BOTTOM_BASE)
#define MSDC1_IO_CONFIG_BASE    (IO_CFG_TOP_BASE)
...
//
////////////////////////////////////////////////////////////////////////
#define GPIO_base               GPIO_BASE //To share the same define with preloader/LK without manual modification from GPIO_base to GPIO_BASE
...
typedef enum MSDC_POWER {
    //This enum is used to differentiate difference power control function pointer msdc_host.power_control()
    MSDC_VIO18_MC1 = 0,
    MSDC_VIO18_MC2,
    MSDC_VIO28_MC1,
    MSDC_VIO28_MC2,
