...
ifneq ($(findstring DiagnosticSemaKinds.inc,$(TBLGEN_TABLES)),)
LOCAL_GENERATED_SOURCES += $(intermediates)/include/clang/Basic/DiagnosticSemaKinds.inc
$(intermediates)/include/clang/Basic/DiagnosticSemaKinds.inc: TBLGEN_LOCAL_MODULE := $(LOCAL_MODULE)
$(intermediates)/include/clang/Basic/DiagnosticSemaKinds.inc: $(CLANG_ROOT_PATH)/include/clang/Basic/Diagnostic.td $(CLANG_TBLGEN)
	$(call transform-host-clang-diagnostic-td-to-out)
endif
...
$(intermediates)/include/clang/Driver/Options.inc: $(CLANG_ROOT_PATH)/include/clang/Driver/Options.td $(TBLGEN)
...
$(intermediates)/include/clang/Driver/CC1AsOptions.inc: $(CLANG_ROOT_PATH)/include/clang/Driver/CC1AsOptions.td $(TBLGEN)
	$(call transform-host-td-to-out,opt-parser-defs)
endif
