...
ifeq ($(MTK_TC1_FEATURE),yes)
    ...
    LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/external/mtk_wifi/libtc1rft
#    LOCAL_C_INCLUDES += $(TOP)/hardware/mediatek/wlan/conn_soc/libtc1rft/
endif
...
LOCAL_C_INCLUDES += \
        ...
        $(MTK_PATH_SOURCE)/external/mtk_wifi/libtc1rft \
