...
mtklog_config_prop_src := $(LOCAL_PATH)/mtklog-config-ext-eng.prop
else
...
mtklog_config_prop_src := $(LOCAL_PATH)/mtklog-config-ext_user.prop
endif
ifeq ($(MTK_FAT_ON_NAND),yes)
mtklog_config_prop_src := $(LOCAL_PATH)/mtklog-config-ext-user.prop
else
ifeq ($(MTK_MULTI_STORAGE_SUPPORT), no)
mtklog_config_prop_src := $(LOCAL_PATH)/mtklog-config-ext-user.prop
else
