...
/* FIXME!! George Kuo: 26MHz TCXO on EVBv1!!! */
    ...
    */
    ...
    {
        MNL_MSG("get COMBO_IOC_GPS_IC_HW_VERSION failed\n");
		return MTK_GPS_ERROR; 
    }

    if (ioctl(dsp_fd, COMBO_IOC_GPS_IC_FW_VERSION, &fw_ver) < 0)
    {
        MNL_MSG("get COMBO_IOC_GPS_IC_FW_VERSION failed\n");
		return MTK_GPS_ERROR; 
    }
	...
	{
		init_cfg.reservedx = MT6630_E2;  /*mnl match E1 or not E1,so we send MT6630_E2 to mnl when it is E3 or E4*/
	}
