...
define add-libcompiler-rt-arm-vfp-source-files
  $(filter-out $(addprefix lib/,adddf3.c addsf3.c comparesf2.c arm/comparesf2.S     \
                                divdf3.c divsf3.c extendsfdf2.c fixdfsi.c fixsfsi.c \
                                fixunsdfsi.c fixunssfsi.c floatsidf.c floatsisf.c   \
                                floatunsidf.c floatunsisf.c muldf3.c mulsf3.c       \
                                negdf2.c negsf2.c subdf3.c subsf3.c truncdfsf2.c),$(1)) lib/arm/vfp_alias.S
endef
...
define build-libcompiler-rt
  ...
  # TODO: Only use Clang to build on-device libcompiler_rt. Current
  # build system always uses TARGET_ARCH to determine the values
  # supplied to "-target" which is not correct for host build.
  # Enable clang for host build once this bug gets fixed.
  ifeq ($$(target_or_host),target)
  # Use MC assembler to compile assembly
  LOCAL_ASFLAGS += -integrated-as  
