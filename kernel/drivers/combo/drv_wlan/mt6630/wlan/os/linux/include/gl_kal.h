...
#define GLUE_FLAG_HIF_PROCESS ( GLUE_FLAG_HALT | GLUE_FLAG_INT | GLUE_FLAG_HIF_TX | GLUE_FLAG_HIF_TX_CMD ) 
...
#define P2P_STATE_LOGFUNC(_Fmt...) xlog_printk(ANDROID_LOG_INFO, XLOG_TAG, _Fmt)
#define P2P_EVENT_LOGFUNC(_Fmt...) xlog_printk(ANDROID_LOG_INFO, XLOG_TAG, _Fmt)
...
#define P2P_ERROR_LOGFUNC(_Fmt...) kalPrint(_Fmt)
#define P2P_WARN_LOGFUNC(_Fmt...) kalPrint(_Fmt)
#define P2P_INFO_LOGFUNC(_Fmt...) kalPrint(_Fmt)
#define P2P_STATE_LOGFUNC(_Fmt...) kalPrint(_Fmt)
#define P2P_EVENT_LOGFUNC(_Fmt...) kalPrint(_Fmt)
#define P2P_TRACE_LOGFUNC(_Fmt...)
#define P2P_LOUD_LOGFUNC(_Fmt...)
#define P2P_TEMP_LOGFUNC(_Fmt...)
...
#define SW4_ERROR_LOGFUNC(_Fmt...)
#define SW4_WARN_LOGFUNC(_Fmt...)
#define SW4_INFO_LOGFUNC(_Fmt...) kalPrint(_Fmt)
#define SW4_STATE_LOGFUNC(_Fmt...)
#define SW4_EVENT_LOGFUNC(_Fmt...)
#define SW4_TRACE_LOGFUNC(_Fmt...)
#define SW4_LOUD_LOGFUNC(_Fmt...)
